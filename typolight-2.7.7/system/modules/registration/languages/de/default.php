...
$GLOBALS['TL_LANG']['MSC']['adminSubject']     = 'TYPOlight :: Neue Registrierung auf %s';
$GLOBALS['TL_LANG']['MSC']['adminText']        = 'Ein neuer Benutzer (ID %s) hat sich auf Ihrer Webseite registriert.%sFalls Sie die automatische E-Mail-Aktivierung nicht nutzen, müssen Sie das Konto manuell im Backend aktivieren.';
