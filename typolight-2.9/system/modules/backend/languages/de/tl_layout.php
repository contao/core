...
$GLOBALS['TL_LANG']['tl_layout']['urchinId']      = array('Google Analytics Id', 'Beachten Sie, dass die Google Analytics Id nicht angezeigt wird, solange Sie im Contao-Backend angemeldet sind.');
