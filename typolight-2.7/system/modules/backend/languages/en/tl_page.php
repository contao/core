...
$GLOBALS['TL_LANG']['tl_page']['jumpTo']         = array('Redirect page', 'Please choose the page to which visitors will be redirected.');
...
$GLOBALS['TL_LANG']['tl_page']['adminEmail']     = array('E-mail address of the website administrator', 'Autogenerated messages like subscription confirmation e-mails will be sent to this address.');
...
$GLOBALS['TL_LANG']['tl_page']['datimFormat']    = array('Date and time format', 'The date and format string will be parsed with the PHP date() function.');
