 ...
 *
 * @method static \NewsletterRecipientsModel findById($id, $opt=array())
 * @method static \NewsletterRecipientsModel findByPk($id, $opt=array())
 * @method static \NewsletterRecipientsModel findByIdOrAlias($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneBy($col, $val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByPid($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByTstamp($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByEmail($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByActive($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneBySource($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByAddedOn($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByConfirmed($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByIp($val, $opt=array())
 * @method static \NewsletterRecipientsModel findOneByToken($val, $opt=array())
 *
