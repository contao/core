 ...
 *
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByEmail($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByActive($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findBySource($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByAddedOn($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByConfirmed($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByIp($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findByToken($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\NewsletterRecipientsModel|null findAll($opt=array())
 *
