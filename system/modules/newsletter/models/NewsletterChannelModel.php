 ...
 *
 * @method static \NewsletterChannelModel findById($id, $opt=array())
 * @method static \NewsletterChannelModel findByPk($id, $opt=array())
 * @method static \NewsletterChannelModel findByIdOrAlias($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBy($col, $val, $opt=array())
 * @method static \NewsletterChannelModel findOneByTstamp($val, $opt=array())
 * @method static \NewsletterChannelModel findOneByTitle($val, $opt=array())
 * @method static \NewsletterChannelModel findOneByJumpTo($val, $opt=array())
 * @method static \NewsletterChannelModel findOneByUseSMTP($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBySmtpHost($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBySmtpUser($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBySmtpPass($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBySmtpEnc($val, $opt=array())
 * @method static \NewsletterChannelModel findOneBySmtpPort($val, $opt=array())
 *
