...
$GLOBALS['TL_LANG']['tl_newsletter']['content'][1] = 'Voer de HTML-inhoud van de nieuwsbrief in. Gebruik wildcard <em>##email##</em> om het e-mail adres van de abonnee in te voegen.';
...
$GLOBALS['TL_LANG']['tl_newsletter']['template'][1] = 'Kies een e-mail template (template groep <em>mail_</em>).';
