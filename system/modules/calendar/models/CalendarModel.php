 ...
 *
 * @method static \Model\Collection|\CalendarModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByTitle($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByJumpTo($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByProtected($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByGroups($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByAllowComments($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByNotify($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findBySortOrder($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByPerPage($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByModerate($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByBbcode($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByRequireLogin($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findByDisableCaptcha($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\CalendarModel|null findAll($opt=array())
 *
