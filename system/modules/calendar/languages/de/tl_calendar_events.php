...
$GLOBALS['TL_LANG']['tl_calendar_events']['default']      = array('Standardseite', 'Beim Anklicken des "Weiterlesen …"-Links wird der Besucher auf die Standardseite des Kalenders weitergeleitet.');
$GLOBALS['TL_LANG']['tl_calendar_events']['internal']     = array('Interne Seite', 'Beim Anklicken des "Weiterlesen …"-Links wird der Besucher auf eine interne Seite weitergeleitet.');
...
$GLOBALS['TL_LANG']['tl_calendar_events']['external']     = array('Externe Webseite', 'Beim Anklicken des "Weiterlesen …"-Links wird der Besucher auf eine externe Webseite weitergeleitet.');
