...
$GLOBALS['TL_LANG']['tl_calendar']['requireLogin'][1] = 'Allow only authenticated users to create comments.';
$GLOBALS['TL_LANG']['tl_calendar']['disableCaptcha'][0] = 'Disable the security question';
...
$GLOBALS['TL_LANG']['tl_calendar']['makeFeed'][0] = 'Generate feed';
$GLOBALS['TL_LANG']['tl_calendar']['makeFeed'][1] = 'Generate an RSS or Atom feed from the calendar.';
$GLOBALS['TL_LANG']['tl_calendar']['format'][0] = 'Feed format';
$GLOBALS['TL_LANG']['tl_calendar']['format'][1] = 'Please choose a feed format.';
$GLOBALS['TL_LANG']['tl_calendar']['language'][0] = 'Feed language';
$GLOBALS['TL_LANG']['tl_calendar']['language'][1] = 'Please enter the feed language according to the ISO-639 standard (e.g. <em>en</em> or <em>en-us</em>).';
$GLOBALS['TL_LANG']['tl_calendar']['source'][0] = 'Export settings';
$GLOBALS['TL_LANG']['tl_calendar']['source'][1] = 'Here you can choose what will be exported.';
$GLOBALS['TL_LANG']['tl_calendar']['maxItems'][0] = 'Maximum number of items';
$GLOBALS['TL_LANG']['tl_calendar']['maxItems'][1] = 'Here you can limit the number of events. Set to 0 to export all.';
$GLOBALS['TL_LANG']['tl_calendar']['feedBase'][0] = 'Base URL';
$GLOBALS['TL_LANG']['tl_calendar']['feedBase'][1] = 'Please enter the base URL with protocol (e.g. <em>http://</em>).';
$GLOBALS['TL_LANG']['tl_calendar']['alias'][0] = 'Feed alias';
$GLOBALS['TL_LANG']['tl_calendar']['alias'][1] = 'Here you can enter a unique filename (without extension). The XML feed file will be auto-generated in the root directory of your Contao installation, e.g. as <em>name.xml</em>.';
$GLOBALS['TL_LANG']['tl_calendar']['description'][0] = 'Feed description';
$GLOBALS['TL_LANG']['tl_calendar']['description'][1] = 'Please enter a short description of the calendar feed.';
...
$GLOBALS['TL_LANG']['tl_calendar']['new'][0] = 'New calendar';
$GLOBALS['TL_LANG']['tl_calendar']['new'][1] = 'Create a new calendar';
$GLOBALS['TL_LANG']['tl_calendar']['show'][0] = 'Calendar details';
$GLOBALS['TL_LANG']['tl_calendar']['show'][1] = 'Show the details of calendar ID %s';
$GLOBALS['TL_LANG']['tl_calendar']['edit'][0] = 'Edit calendar';
$GLOBALS['TL_LANG']['tl_calendar']['edit'][1] = 'Edit calendar ID %s';
$GLOBALS['TL_LANG']['tl_calendar']['editheader'][0] = 'Edit calendar settings';
$GLOBALS['TL_LANG']['tl_calendar']['editheader'][1] = 'Edit the settings of calendar ID %s';
$GLOBALS['TL_LANG']['tl_calendar']['copy'][0] = 'Duplicate calendar';
$GLOBALS['TL_LANG']['tl_calendar']['copy'][1] = 'Duplicate calendar ID %s';
$GLOBALS['TL_LANG']['tl_calendar']['delete'][0] = 'Delete calendar';
$GLOBALS['TL_LANG']['tl_calendar']['delete'][1] = 'Delete calendar ID %s';
$GLOBALS['TL_LANG']['tl_calendar']['feeds'][0] = 'RSS feeds';
$GLOBALS['TL_LANG']['tl_calendar']['feeds'][1] = 'Manage RSS feeds';
