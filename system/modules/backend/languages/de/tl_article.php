...
$GLOBALS['TL_LANG']['tl_article']['cssID']      = array('Stylesheet-ID und -Klasse', 'Hier können Sie eine Stylesheet-ID (id attribute) sowie eine oder mehrere Stylesheet-Klassen (class attribute) eingeben, um den Artikel mittels CSS formatieren zu können.');
