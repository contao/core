...
$GLOBALS['TL_LANG']['tl_article']['cssID']      = array('CSS-ID und -Klasse', 'Hier können Sie eine CSS-ID (id attribute) sowie eine oder mehrere CSS-Klassen (class attributes) eingeben.');
