...
$GLOBALS['TL_LANG']['tl_page']['cssClass']       = array('CSS-Klasse', 'Die CSS-Klasse wird sowohl auf den Menüpunkt in der Navigation, als auch auf das body-Tag angewandt.');
...
$GLOBALS['TL_LANG']['tl_page']['tabindex']       = array('Tabulator-Reihenfolge', 'Diese Zahl bestimmt die Position des aktuellen Menüpunktes innerhalb der Reihenfolge der Tabulatoren.');
...
$GLOBALS['TL_LANG']['tl_page']['dns']            = array('Domainname', 'Wenn Sie einem Startpunkt einer neuen Webseite einen Domainnamen zuweisen, werden Ihre Besucher automatisch zu dieser Webseite umgeleitet, wenn sie den entsprechenden Domainnamen eingeben (z.B. <em>Ihre-Seite.de</em>).');
