...
$GLOBALS['TL_LANG']['tl_page']['mobile']         = array('Mobile Webseite', 'Diesen Startpunkt verwenden wenn der Besucher ein mobiles Endgerät nutzt.');
...
$GLOBALS['TL_LANG']['tl_page']['static_legend']    = 'Statische URLs';
