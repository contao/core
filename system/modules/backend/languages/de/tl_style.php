...
$GLOBALS['TL_LANG']['tl_style']['size']           = array('Größe und Position', 'Width, height, position, overflow, float, clear und display.');
...
$GLOBALS['TL_LANG']['tl_style']['background']     = array('Hintergrund', 'Background-color, background-image, background-position und background-repeat.');
...
$GLOBALS['TL_LANG']['tl_style']['border']         = array('Rahmen', 'Border-width, border-style, border-color und border-collapse.');
...
$GLOBALS['TL_LANG']['tl_style']['size_legend']       = 'Abmessungen und Position';
