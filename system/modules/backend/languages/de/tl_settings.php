...
$GLOBALS['TL_LANG']['tl_settings']['disableAlias']        = array('Keine Seitenaliase verwenden', 'Wählen Sie diese Option um die numerische ID einer Seite anstelle des gespeicherten Seitenalias zu verwenden (z.B. <em>index.php?id=12</em> anstatt <em>startseite.html</em>).');
