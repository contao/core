...
$GLOBALS['TL_LANG']['tl_install']['changePass']  = array('Installtool-Passwort', 'Um dieses Skript weiter abzusichern, können Sie entweder den Befehl <strong>exit;</strong> in die Datei <strong>contao/install.php</strong> einfügen, oder diese komplett von Ihrem Server entfernen. In beiden Fällen müssten Sie Änderungen an den Systemeinstellungen dann direkt in der lokalen Konfigurationsdatei erfassen.');
