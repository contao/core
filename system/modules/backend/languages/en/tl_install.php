...
$GLOBALS['TL_LANG']['tl_install']['update292']      = 'It seems that you are upgrading from a Contao version prior to version 2.9.2. If that is the case, <strong>it is required to run the version 2.9.2 update</strong> to ensure the integrity of your data!';
$GLOBALS['TL_LANG']['tl_install']['update292run']   = 'Run version 2.9.2 update';
