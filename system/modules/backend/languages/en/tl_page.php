...
$GLOBALS['TL_LANG']['tl_page']['subdomains']     = array('Include Subdomains', 'Additionally allows access to the website via all subdomains of the configured domain name. This option has no effect, if no domain name is configured.');
