...
$GLOBALS['TL_LANG']['tl_page']['mobile']         = array('Mobile website', 'Show this root page if the visitor uses a mobile device.');
...
$GLOBALS['TL_LANG']['tl_page']['static_legend']    = 'Static URLs';
