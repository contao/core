...
$GLOBALS['TL_LANG']['tl_content']['code']         = array('Code', 'Note that the code will not be executed. Use F11 to toggle the fullsceen mode if you are using the code editor.');
