...
(
	...
	(
		...
		'defaultSizeFormat' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['defaultSizeFormat'],
			'inputType'               => 'select',
			'options'                 => array('decimal', 'binary'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_settings'],
			'eval'                    => array('tl_class'=>'w50')
		),
		'uploadPath' => array
