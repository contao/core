...
(
	...
	(
		...
		'root'                        => '{title_legend},title,alias,type;{meta_legend},pageTitle,adminEmail,dateFormat,timeFormat,datimFormat;{dns_legend},dns,subdomains,staticFiles,staticSystem,staticPlugins,language,fallback;{sitemap_legend:hide},createSitemap;{layout_legend:hide},includeLayout;{cache_legend:hide},includeCache;{chmod_legend:hide},includeChmod;{publish_legend},published,start,stop',
	...
	(
		...
		'subdomains' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_page']['subdomains'],
			'exclude'                 => true,
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'cbx w50 m12')
		),
		'staticFiles' => array
		(
