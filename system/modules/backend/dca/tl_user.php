...
(
	...
	(
		...
		'login'                       => '{name_legend},name,email;{backend_legend},language,uploader,showHelp,thumbnails,useRTE,useCE;{theme_legend:hide},backendTheme;{session_legend},session;{password_legend},password',
