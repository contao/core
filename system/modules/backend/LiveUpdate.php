...
class LiveUpdate extends Backend implements executable
{
	...
	public function run()
	{
		...
		$objTemplate->updateMessage = sprintf('%s <a href="%sCHANGELOG.txt" data-lightbox="external 80%% 80%%" title="%s"><img src="%s" width="14" height="14" alt="%s" style="vertical-align:text-bottom;padding-left:3px"></a>',
