...
$GLOBALS['TL_LANG']['tl_settings']['repository_listsize'][1] = 'Définir le nombre d\'extensions a afficher par page.';
$GLOBALS['TL_LANG']['tl_settings']['repository_unsafe_catalog'][0] = 'Afficher les extensions incompatibles';
$GLOBALS['TL_LANG']['tl_settings']['repository_unsafe_catalog'][1] = 'Affiche les extensions incompatibles dans le catalogue d\'extensions. Notez que l\'installation des extensions incompatibles peut endommager votre installation Contao !';
$GLOBALS['TL_LANG']['tl_settings']['repository_legend'] = 'Extension référentiel';
