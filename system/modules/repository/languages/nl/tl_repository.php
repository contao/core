...
$GLOBALS['TL_LANG']['tl_repository']['releasedate'][1] = 'Geef de datum van publicatie van deze uitgave in als JJJJ-MM-DD.';
...
$GLOBALS['TL_LANG']['tl_repository']['uninstprotect'][0] = 'Verwijderingsbescherming';
