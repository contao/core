...
/**
 * Class ModuleNavigationMain
 *
 * Front end module "navigation main".
 * @copyright  Leo Feyer 2005
 * @author     Leo Feyer <leo@typolight.org>
 * @package    Controller
 */
class ModuleNavigationMain extends Module
{
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### NAVIGATION MAIN ITEMS ###';
	...
	protected function compile()
	{
		...
		$this->Template->items = $this->renderNavigation($objPage->rootId);
	}
}
