 ...
 *
 * @method static \CommentsNotifyModel findById($id, $opt=array())
 * @method static \CommentsNotifyModel findByPk($id, $opt=array())
 * @method static \CommentsNotifyModel findByIdOrAlias($val, $opt=array())
 * @method static \CommentsNotifyModel findOneBy($col, $val, $opt=array())
 * @method static \CommentsNotifyModel findOneByTstamp($val, $opt=array())
 * @method static \CommentsNotifyModel findOneBySource($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByParent($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByName($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByEmail($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByUrl($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByAddedOn($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByIp($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByTokenConfirm($val, $opt=array())
 * @method static \CommentsNotifyModel findOneByTokenRemove($val, $opt=array())
 *
