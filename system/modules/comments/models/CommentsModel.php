 ...
 *
 * @method static \CommentsModel findById($id, $opt=array())
 * @method static \CommentsModel findByPk($id, $opt=array())
 * @method static \CommentsModel findByIdOrAlias($val, $opt=array())
 * @method static \CommentsModel findOneBy($col, $val, $opt=array())
 * @method static \CommentsModel findOneByTstamp($val, $opt=array())
 * @method static \CommentsModel findOneBySource($val, $opt=array())
 * @method static \CommentsModel findOneByParent($val, $opt=array())
 * @method static \CommentsModel findOneByDate($val, $opt=array())
 * @method static \CommentsModel findOneByName($val, $opt=array())
 * @method static \CommentsModel findOneByEmail($val, $opt=array())
 * @method static \CommentsModel findOneByWebsite($val, $opt=array())
 * @method static \CommentsModel findOneByComment($val, $opt=array())
 * @method static \CommentsModel findOneByAddReply($val, $opt=array())
 * @method static \CommentsModel findOneByAuthor($val, $opt=array())
 * @method static \CommentsModel findOneByReply($val, $opt=array())
 * @method static \CommentsModel findOneByPublished($val, $opt=array())
 * @method static \CommentsModel findOneByIp($val, $opt=array())
 * @method static \CommentsModel findOneByNotified($val, $opt=array())
 *
