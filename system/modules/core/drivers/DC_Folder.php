...
';
	...
	protected function generateTree($path, $intMargin, $mount=false, $blnProtected=false, $arrClipboard=null)
	{
		...
		for ($f=0, $c=count($folders); $f<$c; $f++)
		{
			...
			$return .= "\n  " . '<li class="tl_folder click2edit" onmouseover="Theme.hoverDiv(this,1)" onmouseout="Theme.hoverDiv(this,0)"'.((\Input::get('act') == 'select') ? ' onclick="Theme.toggleSelect(this)"' : '').'><div class="tl_left" style="padding-left:'.($intMargin + (($countFiles < 1) ? 20 : 0)).'px">';
		...
		for ($h=0, $c=count($files); $h<$c; $h++)
		{
			...
			$return .= "\n  " . '<li class="tl_file click2edit" onmouseover="Theme.hoverDiv(this,1)" onmouseout="Theme.hoverDiv(this,0)"'.((\Input::get('act') == 'select') ? ' onclick="Theme.toggleSelect(this)"' : '').'><div class="tl_left" style="padding-left:'.($intMargin + $intSpacing).'px">';
