...
class LiveUpdate extends \Backend implements \executable
{
	...
	public function run()
	{
		...
		$strMessage = ' <a href="'.$GLOBALS['TL_CONFIG']['backendPath'].'/changelog.php" onclick="Backend.openModalIframe({\'width\':860,\'title\':\'CHANGELOG\',\'url\':this.href});return false" title="' . specialchars($GLOBALS['TL_LANG']['tl_maintenance']['changelog']) . '"><img src="' . TL_FILES_URL . 'system/themes/' . \Backend::getTheme() . '/images/changelog.gif" width="14" height="14" alt="" style="vertical-align:text-bottom;padding-left:3px"></a>';
