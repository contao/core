 ...
 *
 * @method static \PageModel findById($id, $opt=array())
 * @method static \PageModel findByPk($id, $opt=array())
 * @method static \PageModel findByIdOrAlias($val, $opt=array())
 * @method static \PageModel findOneBy($col, $val, $opt=array())
 * @method static \PageModel findOneByPid($val, $opt=array())
 * @method static \PageModel findOneBySorting($val, $opt=array())
 * @method static \PageModel findOneByTstamp($val, $opt=array())
 * @method static \PageModel findOneByTitle($val, $opt=array())
 * @method static \PageModel findOneByAlias($val, $opt=array())
 * @method static \PageModel findOneByType($val, $opt=array())
 * @method static \PageModel findOneByPageTitle($val, $opt=array())
 * @method static \PageModel findOneByLanguage($val, $opt=array())
 * @method static \PageModel findOneByRobots($val, $opt=array())
 * @method static \PageModel findOneByDescription($val, $opt=array())
 * @method static \PageModel findOneByRedirect($val, $opt=array())
 * @method static \PageModel findOneByJumpTo($val, $opt=array())
 * @method static \PageModel findOneByUrl($val, $opt=array())
 * @method static \PageModel findOneByTarget($val, $opt=array())
 * @method static \PageModel findOneByDns($val, $opt=array())
 * @method static \PageModel findOneByStaticFiles($val, $opt=array())
 * @method static \PageModel findOneByStaticPlugins($val, $opt=array())
 * @method static \PageModel findOneByFallback($val, $opt=array())
 * @method static \PageModel findOneByAdminEmail($val, $opt=array())
 * @method static \PageModel findOneByDateFormat($val, $opt=array())
 * @method static \PageModel findOneByTimeFormat($val, $opt=array())
 * @method static \PageModel findOneByDatimFormat($val, $opt=array())
 * @method static \PageModel findOneByCreateSitemap($val, $opt=array())
 * @method static \PageModel findOneBySitemapName($val, $opt=array())
 * @method static \PageModel findOneByUseSSL($val, $opt=array())
 * @method static \PageModel findOneByAutoforward($val, $opt=array())
 * @method static \PageModel findOneByProtected($val, $opt=array())
 * @method static \PageModel findOneByGroups($val, $opt=array())
 * @method static \PageModel findOneByIncludeLayout($val, $opt=array())
 * @method static \PageModel findOneByLayout($val, $opt=array())
 * @method static \PageModel findOneByMobileLayout($val, $opt=array())
 * @method static \PageModel findOneByIncludeCache($val, $opt=array())
 * @method static \PageModel findOneByCache($val, $opt=array())
 * @method static \PageModel findOneByIncludeChmod($val, $opt=array())
 * @method static \PageModel findOneByCuser($val, $opt=array())
 * @method static \PageModel findOneByCgroup($val, $opt=array())
 * @method static \PageModel findOneByChmod($val, $opt=array())
 * @method static \PageModel findOneByNoSearch($val, $opt=array())
 * @method static \PageModel findOneByCssClass($val, $opt=array())
 * @method static \PageModel findOneBySitemap($val, $opt=array())
 * @method static \PageModel findOneByHide($val, $opt=array())
 * @method static \PageModel findOneByGuests($val, $opt=array())
 * @method static \PageModel findOneByTabindex($val, $opt=array())
 * @method static \PageModel findOneByAccesskey($val, $opt=array())
 * @method static \PageModel findOneByPublished($val, $opt=array())
 * @method static \PageModel findOneByStart($val, $opt=array())
 * @method static \PageModel findOneByStop($val, $opt=array())
 *
