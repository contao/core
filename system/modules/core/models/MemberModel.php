 ...
 *
 * @method static \Model\Collection|\MemberModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByFirstname($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLastname($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByDateOfBirth($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByGender($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByCompany($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByStreet($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByPostal($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByCity($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByState($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByCountry($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByPhone($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByMobile($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByFax($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByEmail($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByWebsite($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLanguage($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByGroups($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLogin($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByPassword($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByAssignDir($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByHomeDir($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByDisable($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByStart($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByStop($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByDateAdded($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLastLogin($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByCurrentLogin($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLoginCount($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByLocked($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findBySession($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByCreatedOn($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByActivation($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findByNewsletter($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\MemberModel|null findAll($opt=array())
 *
