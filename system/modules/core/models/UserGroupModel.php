 ...
 *
 * @method static \Model\Collection|\UserGroupModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByModules($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByThemes($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByPagemounts($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByAlpty($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByFilemounts($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByFop($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByForms($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByFormp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByAlexf($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByDisable($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByStart($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByStop($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByCalendars($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByCalendarp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByCalendarfeeds($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByCalendarfeedp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByFaqs($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByFaqp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNews($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNewp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNewsfeeds($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNewsfeedp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNewsletters($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findByNewsletterp($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\UserGroupModel|null findAll($opt=array())
 *
