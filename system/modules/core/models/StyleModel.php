 ...
 *
 * @method static \Model\Collection|\StyleModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findBySorting($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findBySelector($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByCategory($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByComment($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findBySize($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByWidth($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByHeight($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByMinwidth($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByMinheight($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByMaxwidth($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByMaxheight($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByPositioning($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByTrbl($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByPosition($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFloating($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByClear($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByOverflow($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByDisplay($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByAlignment($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByMargin($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByPadding($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByAlign($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByVerticalalign($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByTextalign($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByWhitespace($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBackground($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBgcolor($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBgimage($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBgposition($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBgrepeat($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByShadowsize($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByShadowcolor($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByGradientAngle($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByGradientColors($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBorder($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBorderwidth($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBorderstyle($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBordercolor($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBorderradius($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBordercollapse($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByBorderspacing($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFont($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFontfamily($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFontsize($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFontcolor($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByLineheight($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByFontstyle($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByTexttransform($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByTextindent($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByLetterspacing($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByWordspacing($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByList($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByListstyletype($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByListstyleimage($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByOwn($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findByInvisible($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\StyleModel|null findAll($opt=array())
 *
