 ...
 *
 * @method static \FilesModel findByIdOrAlias($val, $opt=array())
 * @method static \FilesModel findByPath($val, $opt=array())
 * @method static \FilesModel findOneBy($col, $val, $opt=array())
 * @method static \FilesModel findOneByPid($val, $opt=array())
 * @method static \FilesModel findOneByTstamp($val, $opt=array())
 * @method static \FilesModel findOneByType($val, $opt=array())
 * @method static \FilesModel findOneByExtension($val, $opt=array())
 * @method static \FilesModel findOneByHash($val, $opt=array())
 * @method static \FilesModel findOneByFound($val, $opt=array())
 * @method static \FilesModel findOneByName($val, $opt=array())
 * @method static \FilesModel findOneByProtected($val, $opt=array())
 * @method static \FilesModel findOneByImportantPartX($val, $opt=array())
 * @method static \FilesModel findOneByImportantPartY($val, $opt=array())
 * @method static \FilesModel findOneByImportantPartWidth($val, $opt=array())
 * @method static \FilesModel findOneByImportantPartHeight($val, $opt=array())
 * @method static \FilesModel findOneByMeta($val, $opt=array())
 *
