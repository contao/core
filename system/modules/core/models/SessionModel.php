 ...
 *
 * @method static \Model\Collection|\SessionModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findBySessionID($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findByIp($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findBySu($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\SessionModel|null findAll($opt=array())
 *
