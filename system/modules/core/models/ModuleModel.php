 ...
 * @method static \ModuleModel[]|\Model\Collection findByPid()
 * @method static \ModuleModel[]|\Model\Collection findByTstamp()
 * @method static \ModuleModel[]|\Model\Collection findByName()
 * @method static \ModuleModel[]|\Model\Collection findByHeadline()
 * @method static \ModuleModel[]|\Model\Collection findByType()
 * @method static \ModuleModel[]|\Model\Collection findByLevelOffset()
 * @method static \ModuleModel[]|\Model\Collection findByShowLevel()
 * @method static \ModuleModel[]|\Model\Collection findByHardLimit()
 * @method static \ModuleModel[]|\Model\Collection findByShowProtected()
 * @method static \ModuleModel[]|\Model\Collection findByDefineRoot()
 * @method static \ModuleModel[]|\Model\Collection findByRootPage()
 * @method static \ModuleModel[]|\Model\Collection findByNavigationTpl()
 * @method static \ModuleModel[]|\Model\Collection findByCustomTpl()
 * @method static \ModuleModel[]|\Model\Collection findByPages()
 * @method static \ModuleModel[]|\Model\Collection findByOrderPages()
 * @method static \ModuleModel[]|\Model\Collection findByShowHidden()
 * @method static \ModuleModel[]|\Model\Collection findByCustomLabel()
 * @method static \ModuleModel[]|\Model\Collection findByAutologin()
 * @method static \ModuleModel[]|\Model\Collection findByJumpTo()
 * @method static \ModuleModel[]|\Model\Collection findByRedirectBack()
 * @method static \ModuleModel[]|\Model\Collection findByCols()
 * @method static \ModuleModel[]|\Model\Collection findByEditable()
 * @method static \ModuleModel[]|\Model\Collection findByMemberTpl()
 * @method static \ModuleModel[]|\Model\Collection findByTableless()
 * @method static \ModuleModel[]|\Model\Collection findByForm()
 * @method static \ModuleModel[]|\Model\Collection findByQueryType()
 * @method static \ModuleModel[]|\Model\Collection findByFuzzy()
 * @method static \ModuleModel[]|\Model\Collection findByContextLength()
 * @method static \ModuleModel[]|\Model\Collection findByTotalLength()
 * @method static \ModuleModel[]|\Model\Collection findByPerPage()
 * @method static \ModuleModel[]|\Model\Collection findBySearchType()
 * @method static \ModuleModel[]|\Model\Collection findBySearchTpl()
 * @method static \ModuleModel[]|\Model\Collection findByInColumn()
 * @method static \ModuleModel[]|\Model\Collection findBySkipFirst()
 * @method static \ModuleModel[]|\Model\Collection findByLoadFirst()
 * @method static \ModuleModel[]|\Model\Collection findBySize()
 * @method static \ModuleModel[]|\Model\Collection findByTransparent()
 * @method static \ModuleModel[]|\Model\Collection findByFlashvars()
 * @method static \ModuleModel[]|\Model\Collection findByAltContent()
 * @method static \ModuleModel[]|\Model\Collection findBySource()
 * @method static \ModuleModel[]|\Model\Collection findBySingleSRC()
 * @method static \ModuleModel[]|\Model\Collection findByUrl()
 * @method static \ModuleModel[]|\Model\Collection findByInteractive()
 * @method static \ModuleModel[]|\Model\Collection findByFlashID()
 * @method static \ModuleModel[]|\Model\Collection findByFlashJS()
 * @method static \ModuleModel[]|\Model\Collection findByImgSize()
 * @method static \ModuleModel[]|\Model\Collection findByUseCaption()
 * @method static \ModuleModel[]|\Model\Collection findByFullsize()
 * @method static \ModuleModel[]|\Model\Collection findByMultiSRC()
 * @method static \ModuleModel[]|\Model\Collection findByOrderSRC()
 * @method static \ModuleModel[]|\Model\Collection findByHtml()
 * @method static \ModuleModel[]|\Model\Collection findByRss_cache()
 * @method static \ModuleModel[]|\Model\Collection findByRss_feed()
 * @method static \ModuleModel[]|\Model\Collection findByRss_template()
 * @method static \ModuleModel[]|\Model\Collection findByNumberOfItems()
 * @method static \ModuleModel[]|\Model\Collection findByDisableCaptcha()
 * @method static \ModuleModel[]|\Model\Collection findByReg_groups()
 * @method static \ModuleModel[]|\Model\Collection findByReg_allowLogin()
 * @method static \ModuleModel[]|\Model\Collection findByReg_skipName()
 * @method static \ModuleModel[]|\Model\Collection findByReg_close()
 * @method static \ModuleModel[]|\Model\Collection findByReg_assignDir()
 * @method static \ModuleModel[]|\Model\Collection findByReg_homeDir()
 * @method static \ModuleModel[]|\Model\Collection findByReg_activate()
 * @method static \ModuleModel[]|\Model\Collection findByReg_jumpTo()
 * @method static \ModuleModel[]|\Model\Collection findByReg_text()
 * @method static \ModuleModel[]|\Model\Collection findByReg_password()
 * @method static \ModuleModel[]|\Model\Collection findByProtected()
 * @method static \ModuleModel[]|\Model\Collection findByGroups()
 * @method static \ModuleModel[]|\Model\Collection findByGuests()
 * @method static \ModuleModel[]|\Model\Collection findByCssID()
 * @method static \ModuleModel[]|\Model\Collection findBySpace()
 * @method static \ModuleModel[]|\Model\Collection findByCal_calendar()
 * @method static \ModuleModel[]|\Model\Collection findByCal_noSpan()
 * @method static \ModuleModel[]|\Model\Collection findByCal_startDay()
 * @method static \ModuleModel[]|\Model\Collection findByCal_format()
 * @method static \ModuleModel[]|\Model\Collection findByCal_ignoreDynamic()
 * @method static \ModuleModel[]|\Model\Collection findByCal_order()
 * @method static \ModuleModel[]|\Model\Collection findByCal_readerModule()
 * @method static \ModuleModel[]|\Model\Collection findByCal_limit()
 * @method static \ModuleModel[]|\Model\Collection findByCal_template()
 * @method static \ModuleModel[]|\Model\Collection findByCal_ctemplate()
 * @method static \ModuleModel[]|\Model\Collection findByCal_showQuantity()
 * @method static \ModuleModel[]|\Model\Collection findByCom_order()
 * @method static \ModuleModel[]|\Model\Collection findByCom_moderate()
 * @method static \ModuleModel[]|\Model\Collection findByCom_bbcode()
 * @method static \ModuleModel[]|\Model\Collection findByCom_requireLogin()
 * @method static \ModuleModel[]|\Model\Collection findByCom_disableCaptcha()
 * @method static \ModuleModel[]|\Model\Collection findByCom_template()
 * @method static \ModuleModel[]|\Model\Collection findByFaq_categories()
 * @method static \ModuleModel[]|\Model\Collection findByFaq_readerModule()
 * @method static \ModuleModel[]|\Model\Collection findByList_table()
 * @method static \ModuleModel[]|\Model\Collection findByList_fields()
 * @method static \ModuleModel[]|\Model\Collection findByList_where()
 * @method static \ModuleModel[]|\Model\Collection findByList_search()
 * @method static \ModuleModel[]|\Model\Collection findByList_sort()
 * @method static \ModuleModel[]|\Model\Collection findByList_info()
 * @method static \ModuleModel[]|\Model\Collection findByList_info_where()
 * @method static \ModuleModel[]|\Model\Collection findByList_layout()
 * @method static \ModuleModel[]|\Model\Collection findByList_info_layout()
 * @method static \ModuleModel[]|\Model\Collection findByNews_archives()
 * @method static \ModuleModel[]|\Model\Collection findByNews_featured()
 * @method static \ModuleModel[]|\Model\Collection findByNews_jumpToCurrent()
 * @method static \ModuleModel[]|\Model\Collection findByNews_readerModule()
 * @method static \ModuleModel[]|\Model\Collection findByNews_metaFields()
 * @method static \ModuleModel[]|\Model\Collection findByNews_template()
 * @method static \ModuleModel[]|\Model\Collection findByNews_format()
 * @method static \ModuleModel[]|\Model\Collection findByNews_startDay()
 * @method static \ModuleModel[]|\Model\Collection findByNews_order()
 * @method static \ModuleModel[]|\Model\Collection findByNews_showQuantity()
 * @method static \ModuleModel[]|\Model\Collection findByNewsletters()
 * @method static \ModuleModel[]|\Model\Collection findByNl_channels()
 * @method static \ModuleModel[]|\Model\Collection findByNl_hideChannels()
 * @method static \ModuleModel[]|\Model\Collection findByNl_subscribe()
 * @method static \ModuleModel[]|\Model\Collection findByNl_unsubscribe()
 * @method static \ModuleModel[]|\Model\Collection findByNl_template()
