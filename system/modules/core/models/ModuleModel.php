 ...
 *
 * @method static \Model\Collection|\ModuleModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByHeadline($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByType($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByLevelOffset($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByShowLevel($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByHardLimit($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByShowProtected($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByDefineRoot($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByRootPage($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNavigationTpl($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCustomTpl($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByPages($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByOrderPages($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByShowHidden($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCustomLabel($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByAutologin($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByJumpTo($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByRedirectBack($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCols($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByEditable($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByMemberTpl($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByTableless($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByForm($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByQueryType($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFuzzy($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByContextLength($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByTotalLength($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByPerPage($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySearchType($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySearchTpl($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByInColumn($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySkipFirst($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByLoadFirst($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySize($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByTransparent($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFlashvars($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByAltContent($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySource($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySingleSRC($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByUrl($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByInteractive($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFlashID($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFlashJS($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByImgSize($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByUseCaption($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFullsize($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByMultiSRC($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByOrderSRC($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByHtml($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByRss_cache($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByRss_feed($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByRss_template($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNumberOfItems($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByDisableCaptcha($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_groups($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_allowLogin($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_skipName($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_close($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_assignDir($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_homeDir($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_activate($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_jumpTo($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_text($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByReg_password($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByProtected($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByGroups($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByGuests($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCssID($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBySpace($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_calendar($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_noSpan($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_startDay($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_format($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_ignoreDynamic($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_order($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_readerModule($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_limit($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_template($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_ctemplate($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCal_showQuantity($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_order($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_moderate($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_bbcode($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_requireLogin($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_disableCaptcha($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByCom_template($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFaq_categories($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByFaq_readerModule($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_table($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_fields($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_where($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_search($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_sort($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_info($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_info_where($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_layout($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByList_info_layout($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_archives($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_featured($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_jumpToCurrent($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_readerModule($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_metaFields($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_template($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_format($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_startDay($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_order($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNews_showQuantity($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNewsletters($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNl_channels($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNl_hideChannels($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNl_subscribe($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNl_unsubscribe($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findByNl_template($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\ModuleModel|null findAll($opt=array())
 *
