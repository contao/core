 ...
 *
 * @method static \ModuleModel findById($id, $opt=array())
 * @method static \ModuleModel findByPk($id, $opt=array())
 * @method static \ModuleModel findByIdOrAlias($val, $opt=array())
 * @method static \ModuleModel findOneBy($col, $val, $opt=array())
 * @method static \ModuleModel findOneByPid($val, $opt=array())
 * @method static \ModuleModel findOneByTstamp($val, $opt=array())
 * @method static \ModuleModel findOneByName($val, $opt=array())
 * @method static \ModuleModel findOneByHeadline($val, $opt=array())
 * @method static \ModuleModel findOneByType($val, $opt=array())
 * @method static \ModuleModel findOneByLevelOffset($val, $opt=array())
 * @method static \ModuleModel findOneByShowLevel($val, $opt=array())
 * @method static \ModuleModel findOneByHardLimit($val, $opt=array())
 * @method static \ModuleModel findOneByShowProtected($val, $opt=array())
 * @method static \ModuleModel findOneByDefineRoot($val, $opt=array())
 * @method static \ModuleModel findOneByRootPage($val, $opt=array())
 * @method static \ModuleModel findOneByNavigationTpl($val, $opt=array())
 * @method static \ModuleModel findOneByCustomTpl($val, $opt=array())
 * @method static \ModuleModel findOneByPages($val, $opt=array())
 * @method static \ModuleModel findOneByOrderPages($val, $opt=array())
 * @method static \ModuleModel findOneByShowHidden($val, $opt=array())
 * @method static \ModuleModel findOneByCustomLabel($val, $opt=array())
 * @method static \ModuleModel findOneByAutologin($val, $opt=array())
 * @method static \ModuleModel findOneByJumpTo($val, $opt=array())
 * @method static \ModuleModel findOneByRedirectBack($val, $opt=array())
 * @method static \ModuleModel findOneByCols($val, $opt=array())
 * @method static \ModuleModel findOneByEditable($val, $opt=array())
 * @method static \ModuleModel findOneByMemberTpl($val, $opt=array())
 * @method static \ModuleModel findOneByTableless($val, $opt=array())
 * @method static \ModuleModel findOneByForm($val, $opt=array())
 * @method static \ModuleModel findOneByQueryType($val, $opt=array())
 * @method static \ModuleModel findOneByFuzzy($val, $opt=array())
 * @method static \ModuleModel findOneByContextLength($val, $opt=array())
 * @method static \ModuleModel findOneByTotalLength($val, $opt=array())
 * @method static \ModuleModel findOneByPerPage($val, $opt=array())
 * @method static \ModuleModel findOneBySearchType($val, $opt=array())
 * @method static \ModuleModel findOneBySearchTpl($val, $opt=array())
 * @method static \ModuleModel findOneByInColumn($val, $opt=array())
 * @method static \ModuleModel findOneBySkipFirst($val, $opt=array())
 * @method static \ModuleModel findOneByLoadFirst($val, $opt=array())
 * @method static \ModuleModel findOneBySize($val, $opt=array())
 * @method static \ModuleModel findOneByTransparent($val, $opt=array())
 * @method static \ModuleModel findOneByFlashvars($val, $opt=array())
 * @method static \ModuleModel findOneByAltContent($val, $opt=array())
 * @method static \ModuleModel findOneBySource($val, $opt=array())
 * @method static \ModuleModel findOneBySingleSRC($val, $opt=array())
 * @method static \ModuleModel findOneByUrl($val, $opt=array())
 * @method static \ModuleModel findOneByInteractive($val, $opt=array())
 * @method static \ModuleModel findOneByFlashID($val, $opt=array())
 * @method static \ModuleModel findOneByFlashJS($val, $opt=array())
 * @method static \ModuleModel findOneByImgSize($val, $opt=array())
 * @method static \ModuleModel findOneByUseCaption($val, $opt=array())
 * @method static \ModuleModel findOneByFullsize($val, $opt=array())
 * @method static \ModuleModel findOneByMultiSRC($val, $opt=array())
 * @method static \ModuleModel findOneByOrderSRC($val, $opt=array())
 * @method static \ModuleModel findOneByHtml($val, $opt=array())
 * @method static \ModuleModel findOneByRss_cache($val, $opt=array())
 * @method static \ModuleModel findOneByRss_feed($val, $opt=array())
 * @method static \ModuleModel findOneByRss_template($val, $opt=array())
 * @method static \ModuleModel findOneByNumberOfItems($val, $opt=array())
 * @method static \ModuleModel findOneByDisableCaptcha($val, $opt=array())
 * @method static \ModuleModel findOneByReg_groups($val, $opt=array())
 * @method static \ModuleModel findOneByReg_allowLogin($val, $opt=array())
 * @method static \ModuleModel findOneByReg_skipName($val, $opt=array())
 * @method static \ModuleModel findOneByReg_close($val, $opt=array())
 * @method static \ModuleModel findOneByReg_assignDir($val, $opt=array())
 * @method static \ModuleModel findOneByReg_homeDir($val, $opt=array())
 * @method static \ModuleModel findOneByReg_activate($val, $opt=array())
 * @method static \ModuleModel findOneByReg_jumpTo($val, $opt=array())
 * @method static \ModuleModel findOneByReg_text($val, $opt=array())
 * @method static \ModuleModel findOneByReg_password($val, $opt=array())
 * @method static \ModuleModel findOneByProtected($val, $opt=array())
 * @method static \ModuleModel findOneByGroups($val, $opt=array())
 * @method static \ModuleModel findOneByGuests($val, $opt=array())
 * @method static \ModuleModel findOneByCssID($val, $opt=array())
 * @method static \ModuleModel findOneBySpace($val, $opt=array())
 * @method static \ModuleModel findOneByCal_calendar($val, $opt=array())
 * @method static \ModuleModel findOneByCal_noSpan($val, $opt=array())
 * @method static \ModuleModel findOneByCal_startDay($val, $opt=array())
 * @method static \ModuleModel findOneByCal_format($val, $opt=array())
 * @method static \ModuleModel findOneByCal_ignoreDynamic($val, $opt=array())
 * @method static \ModuleModel findOneByCal_order($val, $opt=array())
 * @method static \ModuleModel findOneByCal_readerModule($val, $opt=array())
 * @method static \ModuleModel findOneByCal_limit($val, $opt=array())
 * @method static \ModuleModel findOneByCal_template($val, $opt=array())
 * @method static \ModuleModel findOneByCal_ctemplate($val, $opt=array())
 * @method static \ModuleModel findOneByCal_showQuantity($val, $opt=array())
 * @method static \ModuleModel findOneByCom_order($val, $opt=array())
 * @method static \ModuleModel findOneByCom_moderate($val, $opt=array())
 * @method static \ModuleModel findOneByCom_bbcode($val, $opt=array())
 * @method static \ModuleModel findOneByCom_requireLogin($val, $opt=array())
 * @method static \ModuleModel findOneByCom_disableCaptcha($val, $opt=array())
 * @method static \ModuleModel findOneByCom_template($val, $opt=array())
 * @method static \ModuleModel findOneByFaq_categories($val, $opt=array())
 * @method static \ModuleModel findOneByFaq_readerModule($val, $opt=array())
 * @method static \ModuleModel findOneByList_table($val, $opt=array())
 * @method static \ModuleModel findOneByList_fields($val, $opt=array())
 * @method static \ModuleModel findOneByList_where($val, $opt=array())
 * @method static \ModuleModel findOneByList_search($val, $opt=array())
 * @method static \ModuleModel findOneByList_sort($val, $opt=array())
 * @method static \ModuleModel findOneByList_info($val, $opt=array())
 * @method static \ModuleModel findOneByList_info_where($val, $opt=array())
 * @method static \ModuleModel findOneByList_layout($val, $opt=array())
 * @method static \ModuleModel findOneByList_info_layout($val, $opt=array())
 * @method static \ModuleModel findOneByNews_archives($val, $opt=array())
 * @method static \ModuleModel findOneByNews_featured($val, $opt=array())
 * @method static \ModuleModel findOneByNews_jumpToCurrent($val, $opt=array())
 * @method static \ModuleModel findOneByNews_readerModule($val, $opt=array())
 * @method static \ModuleModel findOneByNews_metaFields($val, $opt=array())
 * @method static \ModuleModel findOneByNews_template($val, $opt=array())
 * @method static \ModuleModel findOneByNews_format($val, $opt=array())
 * @method static \ModuleModel findOneByNews_startDay($val, $opt=array())
 * @method static \ModuleModel findOneByNews_order($val, $opt=array())
 * @method static \ModuleModel findOneByNews_showQuantity($val, $opt=array())
 * @method static \ModuleModel findOneByNewsletters($val, $opt=array())
 * @method static \ModuleModel findOneByNl_channels($val, $opt=array())
 * @method static \ModuleModel findOneByNl_hideChannels($val, $opt=array())
 * @method static \ModuleModel findOneByNl_subscribe($val, $opt=array())
 * @method static \ModuleModel findOneByNl_unsubscribe($val, $opt=array())
 * @method static \ModuleModel findOneByNl_template($val, $opt=array())
 *
