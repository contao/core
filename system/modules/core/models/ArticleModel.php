 ...
 *
 * @method static \ArticleModel findById($id, $opt=array())
 * @method static \ArticleModel findByPk($id, $opt=array())
 * @method static \ArticleModel findByIdOrAlias($val, $opt=array())
 * @method static \ArticleModel findOneBy($col, $val, $opt=array())
 * @method static \ArticleModel findOneByPid($val, $opt=array())
 * @method static \ArticleModel findOneBySorting($val, $opt=array())
 * @method static \ArticleModel findOneByTstamp($val, $opt=array())
 * @method static \ArticleModel findOneByTitle($val, $opt=array())
 * @method static \ArticleModel findOneByAlias($val, $opt=array())
 * @method static \ArticleModel findOneByAuthor($val, $opt=array())
 * @method static \ArticleModel findOneByInColumn($val, $opt=array())
 * @method static \ArticleModel findOneByKeywords($val, $opt=array())
 * @method static \ArticleModel findOneByShowTeaser($val, $opt=array())
 * @method static \ArticleModel findOneByTeaserCssID($val, $opt=array())
 * @method static \ArticleModel findOneByTeaser($val, $opt=array())
 * @method static \ArticleModel findOneByPrintable($val, $opt=array())
 * @method static \ArticleModel findOneByCustomTpl($val, $opt=array())
 * @method static \ArticleModel findOneByProtected($val, $opt=array())
 * @method static \ArticleModel findOneByGroups($val, $opt=array())
 * @method static \ArticleModel findOneByGuests($val, $opt=array())
 * @method static \ArticleModel findOneByCssID($val, $opt=array())
 * @method static \ArticleModel findOneBySpace($val, $opt=array())
 * @method static \ArticleModel findOneByPublished($val, $opt=array())
 * @method static \ArticleModel findOneByStart($val, $opt=array())
 * @method static \ArticleModel findOneByStop($val, $opt=array())
 *
