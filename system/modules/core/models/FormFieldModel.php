 ...
 *
 * @method static \Model\Collection|\FormFieldModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findBySorting($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByInvisible($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByType($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByLabel($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByText($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByHtml($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByOptions($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByMandatory($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByRgxp($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByPlaceholder($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByMinlength($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByMaxlength($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findBySize($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByMultiple($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByMSize($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByExtensions($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByStoreFile($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByUploadFolder($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByUseHomeDir($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByDoNotOverwrite($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByFsType($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByClass($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByValue($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByAccesskey($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByTabindex($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByFSize($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByCustomTpl($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByAddSubmit($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findBySlabel($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findByImageSubmit($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findBySingleSRC($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\FormFieldModel|null findAll($opt=array())
 *
