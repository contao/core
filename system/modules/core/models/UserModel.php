 ...
 *
 * @method static \Model\Collection|\UserModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByEmail($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByLanguage($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByBackendTheme($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByUploader($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByShowHelp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByThumbnails($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByUseRTE($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByUseCE($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByPassword($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByPwChange($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByAdmin($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByGroups($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByInherit($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByModules($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByThemes($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByPagemounts($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByAlpty($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByFilemounts($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByFop($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByForms($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByFormp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByDisable($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByStart($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByStop($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findBySession($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByDateAdded($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByLastLogin($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByCurrentLogin($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByLoginCount($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByLocked($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByCalendars($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByCalendarp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByCalendarfeeds($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByCalendarfeedp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByFaqs($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByFaqp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNews($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNewp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNewsfeeds($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNewsfeedp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNewsletters($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findByNewsletterp($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\UserModel|null findAll($opt=array())
 *
