 ...
 * @method static \UserModel[]|\Model\Collection findByTstamp()
 * @method static \UserModel[]|\Model\Collection findByName()
 * @method static \UserModel[]|\Model\Collection findByEmail()
 * @method static \UserModel[]|\Model\Collection findByLanguage()
 * @method static \UserModel[]|\Model\Collection findByBackendTheme()
 * @method static \UserModel[]|\Model\Collection findByUploader()
 * @method static \UserModel[]|\Model\Collection findByShowHelp()
 * @method static \UserModel[]|\Model\Collection findByThumbnails()
 * @method static \UserModel[]|\Model\Collection findByUseRTE()
 * @method static \UserModel[]|\Model\Collection findByUseCE()
 * @method static \UserModel[]|\Model\Collection findByPassword()
 * @method static \UserModel[]|\Model\Collection findByPwChange()
 * @method static \UserModel[]|\Model\Collection findByAdmin()
 * @method static \UserModel[]|\Model\Collection findByGroups()
 * @method static \UserModel[]|\Model\Collection findByInherit()
 * @method static \UserModel[]|\Model\Collection findByModules()
 * @method static \UserModel[]|\Model\Collection findByThemes()
 * @method static \UserModel[]|\Model\Collection findByPagemounts()
 * @method static \UserModel[]|\Model\Collection findByAlpty()
 * @method static \UserModel[]|\Model\Collection findByFilemounts()
 * @method static \UserModel[]|\Model\Collection findByFop()
 * @method static \UserModel[]|\Model\Collection findByForms()
 * @method static \UserModel[]|\Model\Collection findByFormp()
 * @method static \UserModel[]|\Model\Collection findByDisable()
 * @method static \UserModel[]|\Model\Collection findByStart()
 * @method static \UserModel[]|\Model\Collection findByStop()
 * @method static \UserModel[]|\Model\Collection findBySession()
 * @method static \UserModel[]|\Model\Collection findByDateAdded()
 * @method static \UserModel[]|\Model\Collection findByLastLogin()
 * @method static \UserModel[]|\Model\Collection findByCurrentLogin()
 * @method static \UserModel[]|\Model\Collection findByLoginCount()
 * @method static \UserModel[]|\Model\Collection findByLocked()
 * @method static \UserModel[]|\Model\Collection findByCalendars()
 * @method static \UserModel[]|\Model\Collection findByCalendarp()
 * @method static \UserModel[]|\Model\Collection findByCalendarfeeds()
 * @method static \UserModel[]|\Model\Collection findByCalendarfeedp()
 * @method static \UserModel[]|\Model\Collection findByFaqs()
 * @method static \UserModel[]|\Model\Collection findByFaqp()
 * @method static \UserModel[]|\Model\Collection findByNews()
 * @method static \UserModel[]|\Model\Collection findByNewp()
 * @method static \UserModel[]|\Model\Collection findByNewsfeeds()
 * @method static \UserModel[]|\Model\Collection findByNewsfeedp()
 * @method static \UserModel[]|\Model\Collection findByNewsletters()
 * @method static \UserModel[]|\Model\Collection findByNewsletterp()
