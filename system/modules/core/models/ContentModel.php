 ...
 * @method static \ContentModel[]|\Model\Collection findByPid()
 * @method static \ContentModel[]|\Model\Collection findByPtable()
 * @method static \ContentModel[]|\Model\Collection findBySorting()
 * @method static \ContentModel[]|\Model\Collection findByTstamp()
 * @method static \ContentModel[]|\Model\Collection findByType()
 * @method static \ContentModel[]|\Model\Collection findByHeadline()
 * @method static \ContentModel[]|\Model\Collection findByText()
 * @method static \ContentModel[]|\Model\Collection findByAddImage()
 * @method static \ContentModel[]|\Model\Collection findBySingleSRC()
 * @method static \ContentModel[]|\Model\Collection findByAlt()
 * @method static \ContentModel[]|\Model\Collection findByTitle()
 * @method static \ContentModel[]|\Model\Collection findBySize()
 * @method static \ContentModel[]|\Model\Collection findByImagemargin()
 * @method static \ContentModel[]|\Model\Collection findByImageUrl()
 * @method static \ContentModel[]|\Model\Collection findByFullsize()
 * @method static \ContentModel[]|\Model\Collection findByCaption()
 * @method static \ContentModel[]|\Model\Collection findByFloating()
 * @method static \ContentModel[]|\Model\Collection findByHtml()
 * @method static \ContentModel[]|\Model\Collection findByListtype()
 * @method static \ContentModel[]|\Model\Collection findByListitems()
 * @method static \ContentModel[]|\Model\Collection findByTableitems()
 * @method static \ContentModel[]|\Model\Collection findBySummary()
 * @method static \ContentModel[]|\Model\Collection findByThead()
 * @method static \ContentModel[]|\Model\Collection findByTfoot()
 * @method static \ContentModel[]|\Model\Collection findByTleft()
 * @method static \ContentModel[]|\Model\Collection findBySortable()
 * @method static \ContentModel[]|\Model\Collection findBySortIndex()
 * @method static \ContentModel[]|\Model\Collection findBySortOrder()
 * @method static \ContentModel[]|\Model\Collection findByMooHeadline()
 * @method static \ContentModel[]|\Model\Collection findByMooStyle()
 * @method static \ContentModel[]|\Model\Collection findByMooClasses()
 * @method static \ContentModel[]|\Model\Collection findByHighlight()
 * @method static \ContentModel[]|\Model\Collection findByShClass()
 * @method static \ContentModel[]|\Model\Collection findByCode()
 * @method static \ContentModel[]|\Model\Collection findByUrl()
 * @method static \ContentModel[]|\Model\Collection findByTarget()
 * @method static \ContentModel[]|\Model\Collection findByTitleText()
 * @method static \ContentModel[]|\Model\Collection findByLinkTitle()
 * @method static \ContentModel[]|\Model\Collection findByEmbed()
 * @method static \ContentModel[]|\Model\Collection findByRel()
 * @method static \ContentModel[]|\Model\Collection findByUseImage()
 * @method static \ContentModel[]|\Model\Collection findByMultiSRC()
 * @method static \ContentModel[]|\Model\Collection findByOrderSRC()
 * @method static \ContentModel[]|\Model\Collection findByUseHomeDir()
 * @method static \ContentModel[]|\Model\Collection findByPerRow()
 * @method static \ContentModel[]|\Model\Collection findByPerPage()
 * @method static \ContentModel[]|\Model\Collection findByNumberOfItems()
 * @method static \ContentModel[]|\Model\Collection findBySortBy()
 * @method static \ContentModel[]|\Model\Collection findByMetaIgnore()
 * @method static \ContentModel[]|\Model\Collection findByGalleryTpl()
 * @method static \ContentModel[]|\Model\Collection findByCustomTpl()
 * @method static \ContentModel[]|\Model\Collection findByPlayerSRC()
 * @method static \ContentModel[]|\Model\Collection findByYoutube()
 * @method static \ContentModel[]|\Model\Collection findByPosterSRC()
 * @method static \ContentModel[]|\Model\Collection findByPlayerSize()
 * @method static \ContentModel[]|\Model\Collection findByAutoplay()
 * @method static \ContentModel[]|\Model\Collection findBySliderDelay()
 * @method static \ContentModel[]|\Model\Collection findBySliderSpeed()
 * @method static \ContentModel[]|\Model\Collection findBySliderStartSlide()
 * @method static \ContentModel[]|\Model\Collection findBySliderContinuous()
 * @method static \ContentModel[]|\Model\Collection findByCteAlias()
 * @method static \ContentModel[]|\Model\Collection findByArticleAlias()
 * @method static \ContentModel[]|\Model\Collection findByArticle()
 * @method static \ContentModel[]|\Model\Collection findByForm()
 * @method static \ContentModel[]|\Model\Collection findByModule()
 * @method static \ContentModel[]|\Model\Collection findByProtected()
 * @method static \ContentModel[]|\Model\Collection findByGroups()
 * @method static \ContentModel[]|\Model\Collection findByGuests()
 * @method static \ContentModel[]|\Model\Collection findByCssID()
 * @method static \ContentModel[]|\Model\Collection findBySpace()
 * @method static \ContentModel[]|\Model\Collection findByInvisible()
 * @method static \ContentModel[]|\Model\Collection findByStart()
 * @method static \ContentModel[]|\Model\Collection findByStop()
 * @method static \ContentModel[]|\Model\Collection findByCom_order()
 * @method static \ContentModel[]|\Model\Collection findByCom_perPage()
 * @method static \ContentModel[]|\Model\Collection findByCom_moderate()
 * @method static \ContentModel[]|\Model\Collection findByCom_bbcode()
 * @method static \ContentModel[]|\Model\Collection findByCom_disableCaptcha()
 * @method static \ContentModel[]|\Model\Collection findByCom_requireLogin()
 * @method static \ContentModel[]|\Model\Collection findByCom_template()
...
class ContentModel extends \Model
{
	 ...
	 *
	 * @return static[]|\Model\Collection|null A collection of models or null if there are no content elements
	 */
