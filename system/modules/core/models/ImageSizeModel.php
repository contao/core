 ...
 *
 * @method static \Model\Collection|\ImageSizeModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findBySizes($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByDensities($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByWidth($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByHeight($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByResizeMode($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findByZoom($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\ImageSizeModel|null findAll($opt=array())
 *
