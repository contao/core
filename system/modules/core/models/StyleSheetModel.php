 ...
 *
 * @method static \StyleSheetModel findById($id, $opt=array())
 * @method static \StyleSheetModel findByPk($id, $opt=array())
 * @method static \StyleSheetModel findByIdOrAlias($val, $opt=array())
 * @method static \StyleSheetModel findOneBy($col, $val, $opt=array())
 * @method static \StyleSheetModel findByName($val, $opt=array())
 * @method static \StyleSheetModel findOneByPid($val, $opt=array())
 * @method static \StyleSheetModel findOneByTstamp($val, $opt=array())
 * @method static \StyleSheetModel findOneByDisablePie($val, $opt=array())
 * @method static \StyleSheetModel findOneByEmbedImages($val, $opt=array())
 * @method static \StyleSheetModel findOneByCc($val, $opt=array())
 * @method static \StyleSheetModel findOneByMedia($val, $opt=array())
 * @method static \StyleSheetModel findOneByMediaQuery($val, $opt=array())
 * @method static \StyleSheetModel findOneByVars($val, $opt=array())
 *
