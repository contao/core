 ...
 *
 * @method static \Model\Collection|\FormModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByTitle($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByAlias($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByJumpTo($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findBySendViaEmail($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByRecipient($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findBySubject($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByFormat($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findBySkipEmpty($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByStoreValues($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByTargetTable($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByMethod($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByNovalidate($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByAttributes($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByFormID($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByTableless($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findByAllowTags($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\FormModel|null findAll($opt=array())
 *
