 ...
 * @method static \Model\Collection|\ThemeModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\ThemeModel|null findByAuthor($val, $opt=array())
 * @method static \Model\Collection|\ThemeModel|null findByFolders($val, $opt=array())
 * @method static \Model\Collection|\ThemeModel|null findByScreenshot($val, $opt=array())
 * @method static \Model\Collection|\ThemeModel|null findByTemplates($val, $opt=array())
 * @method static \Model\Collection|\ThemeModel|null findByVars($val, $opt=array())
