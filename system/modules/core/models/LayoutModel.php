 ...
 *
 * @method static \Model\Collection|\LayoutModel|null findByPid($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByName($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByRows($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByHeaderHeight($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByFooterHeight($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByCols($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByWidthLeft($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByWidthRight($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findBySections($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findBySPosition($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByFramework($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByStylesheet($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByExternal($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByOrderExt($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByLoadingOrder($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByNewsfeeds($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByCalendarfeeds($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByModules($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByTemplate($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByDoctype($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByWebfonts($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByPicturefill($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByViewport($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByTitleTag($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByCssClass($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByOnload($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByHead($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByAddJQuery($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByJSource($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByJquery($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByAddMooTools($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByMooSource($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByMootools($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByAnalytics($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByScript($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByStatic($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByWidth($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findByAlign($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\LayoutModel|null findAll($opt=array())
 *
