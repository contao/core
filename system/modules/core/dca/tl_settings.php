...
(
	...
	(
		...
		'useProgressiveJpegs' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['useProgressiveJpegs'],
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50')
		),
		'gdMaxImgWidth' => array
