...
(
	...
	(
		...
		'backendPath' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['backendPath'],
			'inputType'               => 'text',
