...
(
	...
	(
		...
		'externalPosition' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_layout']['externalPosition'],
			'default'                 => 'after',
			'exclude'                 => true,
			'inputType'               => 'select',
			'options'                 => array('before', 'after'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_layout']['externalPositions'],
			'sql'                     => "varchar(32) NOT NULL default ''"
		),
		'orderExt' => array
		(
		...
		(
			...
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('decodeEntities'=>true, 'maxlength'=>64, 'tl_class'=>'w50'),
			'sql'                     => "varchar(64) NOT NULL default ''"
		),
		'titleTag' => array
		(
