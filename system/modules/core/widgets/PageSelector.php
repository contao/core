...
class PageSelector extends \Widget
{
	...
	protected function renderPagetree($id, $intMargin, $protectedPage=false, $blnNoRecursion=false)
	{
		...
		$return .= "\n    " . '<li class="'.(($objPage->type == 'root') ? 'tl_folder' : 'tl_file').'" onmouseover="Theme.hoverDiv(this, 1)" onmouseout="Theme.hoverDiv(this, 0)"'.((\Input::get('act') == 'select') ? ' onclick="Theme.toggleSelect(this)"' : '').'><div class="tl_left" style="padding-left:'.($intMargin + $intSpacing).'px">';
