...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = 'Filen eller mappen "%s" finns redan!';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = 'Ingen databaspost existerar för %s.';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = 'Databasen och filsystemet måste synkroniseras för att kunna fortsätta.';
...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Lär dig mer om att snabba upp ditt arbete i backend genom att använda  <a href="https://contao.org/en/manual/3.0/administration-area.html#keyboard-shortcuts" title="Keyboard shortcuts overview on contao.org" target="_blank">snabbtangenter</a>.';
