...
$GLOBALS['TL_LANG']['tl_page']['language'][1] = 'Ange vilket språk du använder på denna sida. Ange språket med hjälp av den primära undertaggen (ISO-639-1), t.ex. "sv" för svenska.';
...
$GLOBALS['TL_LANG']['tl_page']['createSitemap'][1] = 'Skapa en Google XML sajtkarta i foldern <em>share/</em>.';
