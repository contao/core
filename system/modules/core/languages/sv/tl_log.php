...
$GLOBALS['TL_LANG']['tl_log']['username'][0] = 'Medlem';
...
$GLOBALS['TL_LANG']['tl_log']['ip'][0] = 'IP-adress';
$GLOBALS['TL_LANG']['tl_log']['ip'][1] = 'Anropande IP-adress';
...
$GLOBALS['TL_LANG']['tl_log']['show'][0] = 'Visa detaljer';
$GLOBALS['TL_LANG']['tl_log']['show'][1] = 'Visa detaljer för post med ID %s';
$GLOBALS['TL_LANG']['tl_log']['delete'][0] = 'Ta bort';
$GLOBALS['TL_LANG']['tl_log']['delete'][1] = 'Ta bort post med ID %s';
