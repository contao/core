...
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = 'Více informací o "insert tags" najdete na <a href="https://contao.org/en/manual/3.0/managing-content.html#insert-tags" title="Dokumentace Contao" target="_blank">https://contao.org/en/manual/3.0/managing-content.html#insert-tags</a>.';
...
$GLOBALS['TL_LANG']['XPL']['dateFormat'][2][1] = 'MM/DD/RRRR, anglický formát př.: 01/28/2005';
$GLOBALS['TL_LANG']['XPL']['dateFormat'][3][0] = 'd.m.Y';
$GLOBALS['TL_LANG']['XPL']['dateFormat'][3][1] = 'DD.MM.RRRR, německý formát př.: 28.01.2005';
