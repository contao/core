...
$GLOBALS['TL_LANG']['tl_form']['title'][0] = '名前';
$GLOBALS['TL_LANG']['tl_form']['title'][1] = 'フォームの名前を入力してください。';
$GLOBALS['TL_LANG']['tl_form']['alias'][0] = 'フォームのエイリアス';
$GLOBALS['TL_LANG']['tl_form']['alias'][1] = 'フォームのエイリアスは、その数値のIDの代わりにフォームを参照できる、重複しない生枝です。';
$GLOBALS['TL_LANG']['tl_form']['jumpTo'][0] = 'リダイレクトページ';
...
$GLOBALS['TL_LANG']['tl_form']['subject'][1] = '電子メールの件名(Subject)を入力してください。';
...
$GLOBALS['TL_LANG']['tl_form']['email'][1] = '<em>email</em>、<em>subject</em>、<em>message</em>、<em>cc</em>(carbon copy)、<em>name</em>(注: 原文に追加)以外の項目の名前の入力項目を無視して、メールのクライアントから送信されたようにフォームのデータを送信します。ファイルのアップロードも可能です。';
...
$GLOBALS['TL_LANG']['tl_form']['tableless'][0] = '表を使用しないレイアウト';
$GLOBALS['TL_LANG']['tl_form']['tableless'][1] = 'HTMLのテーブルを使用しないでページを生成します。';
...
$GLOBALS['TL_LANG']['tl_form']['title_legend'] = '題名とリダイレクトページ';
...
$GLOBALS['TL_LANG']['tl_form']['new'][0] = '新しいフォーム';
$GLOBALS['TL_LANG']['tl_form']['new'][1] = '新しくフォームを作成';
$GLOBALS['TL_LANG']['tl_form']['show'][0] = 'フォームの詳細';
$GLOBALS['TL_LANG']['tl_form']['show'][1] = 'ID %sのフォームの詳細を表示';
$GLOBALS['TL_LANG']['tl_form']['edit'][0] = 'フォームを編集';
$GLOBALS['TL_LANG']['tl_form']['edit'][1] = 'ID %sのフォームを編集';
$GLOBALS['TL_LANG']['tl_form']['editheader'][0] = 'フォームの設定を変更';
$GLOBALS['TL_LANG']['tl_form']['editheader'][1] = 'ID %sのフォームの設定を変更';
$GLOBALS['TL_LANG']['tl_form']['copy'][0] = 'フォームを複製';
$GLOBALS['TL_LANG']['tl_form']['copy'][1] = 'ID %sのフォームを複製';
$GLOBALS['TL_LANG']['tl_form']['delete'][0] = 'フォームを削除';
$GLOBALS['TL_LANG']['tl_form']['delete'][1] = 'ID %sのフォームを削除';
