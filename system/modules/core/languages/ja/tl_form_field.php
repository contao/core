...
$GLOBALS['TL_LANG']['FFL']['headline'][0] = '見出し';
$GLOBALS['TL_LANG']['FFL']['headline'][1] = 'セクションの見出しを入れるフォームの項目です。';
...
$GLOBALS['TL_LANG']['FFL']['fieldset'][0] = 'フィールドセット';
$GLOBALS['TL_LANG']['FFL']['fieldset'][1] = 'オプションで見出しを付けられる、フォームの項目のコンテナです。';
...
$GLOBALS['TL_LANG']['FFL']['upload'][0] = 'ファイルアップロード';
...
$GLOBALS['TL_LANG']['FFL']['captcha'][1] = '(ボットのようなプログラムではなく)人間によってフォームが提出されたことを検証するための、やさしい計算問題です。(CAPTCHA)';
...
$GLOBALS['TL_LANG']['tl_form_field']['digit'][1] = '数字、マイナス(-)、ドット(.)、スペース文字( )を許可します。';
...
$GLOBALS['TL_LANG']['tl_form_field']['extnd'][1] = 'セキュリティ上の理由で、通常はエンコードが必要な特殊文字(#/()<=>)以外のすべてを許可します。';
...
$GLOBALS['TL_LANG']['tl_form_field']['useHomeDir'][1] = 'ログインしたユーザーの場合はホームディレクトリにファイルを保存します。';
...
$GLOBALS['TL_LANG']['tl_form_field']['fsType'][0] = '動作モード';
$GLOBALS['TL_LANG']['tl_form_field']['fsType'][1] = 'フィールドセット要素の動作モードを選択してください。';
$GLOBALS['TL_LANG']['tl_form_field']['fsStart'][0] = 'ラッパーの開始';
$GLOBALS['TL_LANG']['tl_form_field']['fsStart'][1] = 'フィールドセットの開始を示し、見出しを含められます。';
$GLOBALS['TL_LANG']['tl_form_field']['fsStop'][0] = 'ラッパーの終了';
$GLOBALS['TL_LANG']['tl_form_field']['fsStop'][1] = 'フィールドセットの終了を示します。';
$GLOBALS['TL_LANG']['tl_form_field']['value'][0] = '初期値';
$GLOBALS['TL_LANG']['tl_form_field']['value'][1] = '入力項目の初期値を入力できます。';
...
$GLOBALS['TL_LANG']['tl_form_field']['tabindex'][0] = 'タブのインデックス';
$GLOBALS['TL_LANG']['tl_form_field']['tabindex'][1] = 'タブキーでフォームの項目間を移動する順序の番号です。';
$GLOBALS['TL_LANG']['tl_form_field']['fSize'][0] = '項目の大きさ';
$GLOBALS['TL_LANG']['tl_form_field']['fSize'][1] = 'アップロードの項目の大きさ(size属性)を入力できます。';
$GLOBALS['TL_LANG']['tl_form_field']['addSubmit'][0] = '提出ボタンを追加';
$GLOBALS['TL_LANG']['tl_form_field']['addSubmit'][1] = '1行のフォームを作成するため、項目の次に提出ボタンを追加します。';
...
$GLOBALS['TL_LANG']['tl_form_field']['new'][0] = '新しい項目';
$GLOBALS['TL_LANG']['tl_form_field']['new'][1] = '新しく項目を作成';
$GLOBALS['TL_LANG']['tl_form_field']['show'][0] = '項目の詳細';
$GLOBALS['TL_LANG']['tl_form_field']['show'][1] = 'ID %sの項目の詳細を表示';
$GLOBALS['TL_LANG']['tl_form_field']['edit'][0] = '項目を編集';
$GLOBALS['TL_LANG']['tl_form_field']['edit'][1] = 'ID %sの項目を編集';
$GLOBALS['TL_LANG']['tl_form_field']['cut'][0] = '項目を移動';
$GLOBALS['TL_LANG']['tl_form_field']['cut'][1] = 'ID %sの項目を移動';
$GLOBALS['TL_LANG']['tl_form_field']['copy'][0] = '項目を複製';
$GLOBALS['TL_LANG']['tl_form_field']['copy'][1] = 'ID %sの項目を複製';
$GLOBALS['TL_LANG']['tl_form_field']['delete'][0] = '項目を削除';
$GLOBALS['TL_LANG']['tl_form_field']['delete'][1] = 'ID %sの項目を削除';
$GLOBALS['TL_LANG']['tl_form_field']['editheader'][0] = 'フォームを変更';
$GLOBALS['TL_LANG']['tl_form_field']['editheader'][1] = 'このフォームの設定を変更';
$GLOBALS['TL_LANG']['tl_form_field']['pasteafter'][0] = '先頭に貼り付け';
$GLOBALS['TL_LANG']['tl_form_field']['pasteafter'][1] = 'ID %sの項目の後に貼り付け';
$GLOBALS['TL_LANG']['tl_form_field']['pastenew'][0] = '先頭に新しく追加';
$GLOBALS['TL_LANG']['tl_form_field']['pastenew'][1] = 'ID %sの項目の後に新しく追加';
$GLOBALS['TL_LANG']['tl_form_field']['toggle'][0] = '表示と非表示を切り替え';
$GLOBALS['TL_LANG']['tl_form_field']['toggle'][1] = 'ID %sの項目の表示と非表示を切り替え';
