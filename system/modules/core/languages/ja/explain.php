...
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = '挿入タグのさらに詳しい情報は<a href="http://contao.org/en/insert-tags.html" title="Contao online documentation" target="_blank">http://contao.org/en/insert-tags.html</a>を参照してください。';
...
$GLOBALS['TL_LANG']['XPL']['highlighter'][0][0] = '構文強調';
$GLOBALS['TL_LANG']['XPL']['highlighter'][0][1] = '構文強調を設定する方法のさらに詳しい情報は、<a href="http://alexgorbatchev.com/wiki/SyntaxHighlighter:Configuration#SyntaxHighlighter.defaults" title="SyntaxHighlighter by Alex Gorbatchev" target="_blank">http://alexgorbatchev.com</a>を参照してください。';
