...
$GLOBALS['TL_LANG']['tl_theme']['title_legend'] = '名前と作成者';
...
$GLOBALS['TL_LANG']['tl_theme']['custom_sections'] = 'カスタムレイアウトセクション';
$GLOBALS['TL_LANG']['tl_theme']['missing_section'] = 'バックエンドの設定でレイアウトセクション<strong>%s</strong>を定義していません。';
$GLOBALS['TL_LANG']['tl_theme']['sections_ok'] = 'レイアウトセクションの検査を完了しました。';
...
$GLOBALS['TL_LANG']['tl_theme']['show'][1] = 'ID %sのテーマの詳細を表示';
$GLOBALS['TL_LANG']['tl_theme']['edit'][0] = 'テーマを変更';
$GLOBALS['TL_LANG']['tl_theme']['edit'][1] = 'ID %sのテーマを変更';
$GLOBALS['TL_LANG']['tl_theme']['delete'][0] = 'テーマを削除';
$GLOBALS['TL_LANG']['tl_theme']['delete'][1] = 'ID %sのテーマを削除';
$GLOBALS['TL_LANG']['tl_theme']['css'][0] = 'スタイルシート';
$GLOBALS['TL_LANG']['tl_theme']['css'][1] = 'ID %sのテーマのスタイルシートを編集';
$GLOBALS['TL_LANG']['tl_theme']['modules'][0] = 'モジュール';
$GLOBALS['TL_LANG']['tl_theme']['modules'][1] = 'ID %sのテーマのフロントエンドモジュールを編集';
$GLOBALS['TL_LANG']['tl_theme']['layout'][0] = 'レイアウト';
$GLOBALS['TL_LANG']['tl_theme']['layout'][1] = 'ID %sのテーマのページレイアウトを編集';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][0] = 'テーマをインポート';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][1] = '新しいテーマをインポート';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][0] = 'エクスポート';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][1] = 'ID %sのテーマをエクスポート';
