...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = '"%s"という名前のファイルまたはフォルダーが既に存在します。';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = '%sに対応するデータベースの項目がありません。';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = '続けるにはデータベースとファイルシステムを同期しなければなりません。';
