...
$GLOBALS['TL_LANG']['tl_log']['action'][1] = 'Catégorie de l\'action';
...
$GLOBALS['TL_LANG']['tl_log']['ip'][1] = 'Adresse IP de l\'utilisateur';
$GLOBALS['TL_LANG']['tl_log']['browser'][0] = 'Navigateur';
$GLOBALS['TL_LANG']['tl_log']['browser'][1] = 'Navigateur de l\'utilisateur';
$GLOBALS['TL_LANG']['tl_log']['BE'] = 'Back office';
$GLOBALS['TL_LANG']['tl_log']['FE'] = 'Front office';
$GLOBALS['TL_LANG']['tl_log']['show'][0] = 'Afficher les détails';
$GLOBALS['TL_LANG']['tl_log']['show'][1] = 'Afficher les détails de l\'entrée ID %s';
$GLOBALS['TL_LANG']['tl_log']['delete'][0] = 'Supprimer';
$GLOBALS['TL_LANG']['tl_log']['delete'][1] = 'Supprimer l\'entrée ID %s';
