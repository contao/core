...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = 'Le fichier ou le dossier "%s" existe déjà !';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = 'Aucun enregistrement trouvé pour %s.';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = 'La base de données et le système de fichiers doivent être synchronisés.';
