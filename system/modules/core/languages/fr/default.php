...
$GLOBALS['TL_LANG']['ERR']['version2format'] = 'Cet élément utilise toujours l\'ancien SCR de Contao 2. Avez-vous mis à jour la base de données ?';
...
$GLOBALS['TL_LANG']['CTE']['player'][1] = 'Générer un lecteur vidéo ou audio.';
$GLOBALS['TL_LANG']['CTE']['youtube'][0] = 'Youtube';
$GLOBALS['TL_LANG']['CTE']['youtube'][1] = 'Ajouter une vidéo Youtube.';
...
$GLOBALS['TL_LANG']['CTE']['article'][1] = 'Insère un article dans un autre article.';
$GLOBALS['TL_LANG']['CTE']['alias'][0] = 'Élément de contenu';
$GLOBALS['TL_LANG']['CTE']['alias'][1] = 'Insère un élément de contenu existant.';
$GLOBALS['TL_LANG']['CTE']['form'][0] = 'Formulaire';
$GLOBALS['TL_LANG']['CTE']['form'][1] = 'Insère un formulaire.';
$GLOBALS['TL_LANG']['CTE']['module'][0] = 'Module';
$GLOBALS['TL_LANG']['CTE']['module'][1] = 'Insère un module.';
...
$GLOBALS['TL_LANG']['PTY']['regular'][1] = 'Une page simple contient des articles et des éléments de contenu. C\'est le type de page de défaut.';
...
$GLOBALS['TL_LANG']['PTY']['error_403'][1] = 'Si un utilisateur sans permission essaye d\'accéder à une page protégée, une page d\'erreur 403 sera retournée. Si un utilisateur sans permission essaye d\'accéder à une page protégée, une page d\'erreur 403 sera retournée.';
...
$GLOBALS['TL_LANG']['MSC']['source'][1] = 'Choisir le fichier CSV que vous voulez importer depuis le répertoire des fichiers';
...
$GLOBALS['TL_LANG']['MSC']['all'][0] = 'Edition multiple';
...
$GLOBALS['TL_LANG']['MSC']['all_fields'][1] = 'Sélectionner les champs que vous voulez éditer.';
...
$GLOBALS['TL_LANG']['MSC']['staticFiles'][1] = 'L\'URL des fichiers s\'applique au répertoire <em>tl_files</em> et à toutes les images miniatures (optimisation de la vitesse de chargement des pages).';
$GLOBALS['TL_LANG']['MSC']['staticPlugins'][0] = 'URL des plugins';
$GLOBALS['TL_LANG']['MSC']['staticPlugins'][1] = 'L\'URL des plugins s\'applique à toutes les ressources se trouvant dans le répertoire <em>plugins</em> (optimisation de la vitesse de chargement des pages).';
...
$GLOBALS['TL_LANG']['MSC']['lockedAccount'][1] = "Le compte Contao suivant a été verrouillé pour des raisons de sécurité.\n\nIdentifiant : %s\nNom réel : %s\nSite web : %s\n\nLe compte a été verrouillé pour %d minutes, parce que l'utilisateur a saisis un mot de passe incorrect trois fois de suite. Après ce laps de temps, le compte sera automatiquement déverrouillé.\n\nCet e-mail a été généré par Contao. Merci de ne pas y répondre directement.\n";
$GLOBALS['TL_LANG']['MSC']['toggleMobile'][0] = 'Version mobile';
$GLOBALS['TL_LANG']['MSC']['toggleMobile'][1] = 'Aller à la version mobile';
$GLOBALS['TL_LANG']['MSC']['toggleDesktop'][0] = 'Version de bureau';
$GLOBALS['TL_LANG']['MSC']['toggleDesktop'][1] = 'Aller à la version de bureau';
...
$GLOBALS['TL_LANG']['MSC']['adminSubject'] = 'Contao :: nouvel enregistrement sur %s';
...
$GLOBALS['TL_LANG']['MSC']['setNewPassword'] = 'Choisir un nouveau mot de passe';
...
$GLOBALS['TL_LANG']['MSC']['noVersions'] = 'Il n\'existe pas de version actuellement.';
...
$GLOBALS['TL_LANG']['MSC']['selectNewPosition'] = 'Ensuite, choisir la (nouvelle) position de l\'élément';
...
$GLOBALS['TL_LANG']['MSC']['gplusShare'] = 'Partagé sur Google+';
