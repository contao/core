...
$GLOBALS['TL_LANG']['tl_maintenance']['cacheTables'][1] = 'Choisir les données que vous souhaitez purger.';
...
$GLOBALS['TL_LANG']['tl_maintenance']['updateHelp'] = 'Veuillez saisir votre %s ici.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['index'][0] = 'Purger l\'index de recherche';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['index'][1] = 'Vider les tables <em>tl_search</em> et <em>tl_search_index</em>. Ensuite, vous devez reconstruire l\'index de recherche (voir ci-dessus).';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['undo'][0] = 'Purger la table des annulations';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['undo'][1] = 'Vider la table <em>tl_undo</em> qui stocke les enregistrements supprimés. Ce travail supprime de façon permanente ces enregistrements.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['versions'][0] = 'Purger la table des versions';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['versions'][1] = 'Vider la table <em>tl_version</em> qui stocke les précédentes versions d\'un enregistrement. Ce travail supprime de façon permanente ces enregistrements.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['scripts'][1] = 'Retire les fichiers .css et .js générés automatiquement, recrée la feuille de style interne et purge la page de cache.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['pages'][0] = 'Purger le cache des pages';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['pages'][1] = 'Retire les versions cache des pages "front end".';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['internal'][0] = 'Purger le cache interne';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['internal'][1] = 'Retire les versions cache du DCA et des fichiers de langue. Vous pouvez désactiver de manière permanente le cache interne dans les paramètres du "back end".';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['temp'][0] = 'Purger le répertoire temporaire';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['temp'][1] = 'Retire les fichiers temporaires.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][0] = 'Recréer les fichiers XML';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Recrée les fichiers XML (carte du site et alimentation)puis purge la page de cache afin de ne pas avoir de liens vers des ressources supprimées.';
