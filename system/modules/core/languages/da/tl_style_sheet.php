...
$GLOBALS['TL_LANG']['tl_style_sheet']['new'][1] = 'Opret et nyt stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['show'][0] = 'Detaljer for stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['show'][1] = 'Vis detaljer for stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['edit'][0] = 'Rediger stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['edit'][1] = 'Rediger stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['editheader'][0] = 'Redigér stilark indstillinger';
$GLOBALS['TL_LANG']['tl_style_sheet']['editheader'][1] = 'Rediger indstillinger for stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['cut'][0] = 'Flyt stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['cut'][1] = 'Flyt stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['copy'][0] = 'Dupliker stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['copy'][1] = 'Dupliker stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['delete'][0] = 'Slet stilark';
$GLOBALS['TL_LANG']['tl_style_sheet']['delete'][1] = 'Slet stilark-ID %s';
$GLOBALS['TL_LANG']['tl_style_sheet']['import'][0] = 'Importer CSS';
$GLOBALS['TL_LANG']['tl_style_sheet']['import'][1] = 'Importér en eksisterende CSS fil';
