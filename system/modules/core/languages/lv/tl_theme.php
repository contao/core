...
$GLOBALS['TL_LANG']['tl_theme']['author'][0] = 'Autors';
...
$GLOBALS['TL_LANG']['tl_theme']['tstamp'][0] = 'Pārskatīšanas datums';
$GLOBALS['TL_LANG']['tl_theme']['tstamp'][1] = 'Pēdējās pārskatīšanas datums un laiks';
...
$GLOBALS['TL_LANG']['tl_theme']['custom_sections'] = 'Pielāgotas salikuma daļas';
$GLOBALS['TL_LANG']['tl_theme']['missing_section'] = 'Salikuma daļa <strong>%s</strong> nav definēta aizmugures uzstādījumos';
$GLOBALS['TL_LANG']['tl_theme']['sections_ok'] = 'Tēma neietver pielāgotas salikuma daļas.';
...
$GLOBALS['TL_LANG']['tl_theme']['new'][0] = 'Jauna tēma';
$GLOBALS['TL_LANG']['tl_theme']['new'][1] = 'Izveidot jaunu tēmu';
$GLOBALS['TL_LANG']['tl_theme']['show'][0] = 'Tēmas detaļas';
$GLOBALS['TL_LANG']['tl_theme']['show'][1] = 'Rādīt tēmas ID %s detaļas';
$GLOBALS['TL_LANG']['tl_theme']['edit'][0] = 'Rediģēt tēmu';
$GLOBALS['TL_LANG']['tl_theme']['edit'][1] = 'Rediģēt tēmu ID %s';
$GLOBALS['TL_LANG']['tl_theme']['delete'][0] = 'Dzēst tēmu';
$GLOBALS['TL_LANG']['tl_theme']['delete'][1] = 'Dzēst tēmu ID %s';
$GLOBALS['TL_LANG']['tl_theme']['css'][0] = 'Stila lapas';
$GLOBALS['TL_LANG']['tl_theme']['css'][1] = 'Rediģēt tēmas ID %s stila lapas';
$GLOBALS['TL_LANG']['tl_theme']['modules'][0] = 'Moduļi';
$GLOBALS['TL_LANG']['tl_theme']['modules'][1] = 'Rediģēt tēmas ID %s priekšgala moduļus';
$GLOBALS['TL_LANG']['tl_theme']['layout'][0] = 'Salikumi';
$GLOBALS['TL_LANG']['tl_theme']['layout'][1] = 'Rediģēt tēmas ID %s lapas salikumus';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][0] = 'Tēmu imports';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][1] = 'Importēt jaunas tēmas';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][0] = 'Eksportēt';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][1] = 'Eksportēt tēmu ID %s';
