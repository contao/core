...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = 'Die Datei bzw. das Verzeichnis "%s" existiert bereits!';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = 'Kein Datenbankeintrag für %s gefunden.';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = 'Die Datenbank und das Dateisystem müssen synchronisiert werden, um fortzufahren.';
