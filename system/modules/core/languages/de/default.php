...
$GLOBALS['TL_LANG']['MSC']['staticFiles']   = array('Datei-URL', 'Die Datei-URL gilt für das <em>files</em>-Verzeichnis (Page-Speed-Optimierung).');
$GLOBALS['TL_LANG']['MSC']['staticPlugins'] = array('Assets-URL', 'Die Assets-URL gilt für das <em>assets</em>-Verzeichnis (Page-Speed-Optimierung).');
