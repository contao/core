...
$GLOBALS['TL_LANG']['tl_settings']['dateFormat']          = array('Datumsformat', 'Der Datumsformat-String wird mit der PHP-Funktion <em>date()</em> geparst.');
$GLOBALS['TL_LANG']['tl_settings']['timeFormat']          = array('Zeitformat', 'Der Zeitformat-String wird mit der PHP-Funktion <em>date()</em> geparst.');
$GLOBALS['TL_LANG']['tl_settings']['datimFormat']         = array('Datums- und Zeitformat', 'Der Datums- und Zeitformat-String wird mit der PHP-Funktion <em>date()</em> geparst.');
...
$GLOBALS['TL_LANG']['tl_settings']['disableCron']         = array('Den Command Scheduler deaktivieren', 'Den Periodic Command Scheduler deaktivieren und das <em>cron.php</em>-Skript mittels eines echten Cronjobs (den Sie selbst einrichten müssen) ausführen.');
$GLOBALS['TL_LANG']['tl_settings']['minifyMarkup']        = array('Markup komprimieren', 'Das HTML-Markup vor dem Senden an den Browser komprimieren (benötigt die PHP <em>tidy</em>-Erweiterung).');
$GLOBALS['TL_LANG']['tl_settings']['gzipScripts']         = array('Skripte komprimieren', 'Eine komprimierte Version der kombinierten CSS- bzw. JavaScript-Dateien erstellen. Erfordert die Anpassung der <em>.htaccess</em>-Datei.');
...
$GLOBALS['TL_LANG']['tl_settings']['fileSyncExclude']     = array('Nicht zu synchronisierende Ordner', 'Hier können Sie eine kommagetrennte Liste von Ordnern eingeben, die von der Dateisynchronisation ausgenommen werden (z.B. <em>attachments,music_academy</em>). Beachten Sie, dass ausgenommene Ressourcen nicht in z.B. Bild- oder Download-Elementen verfügbar sind!');
...
$GLOBALS['TL_LANG']['tl_settings']['rewriteURL']          = array('URLs umschreiben', 'Statische URLs ohne das <em>index.php</em>-Fragment erzeugen. Für diese Funktion muss <em>mod_rewrite</em> verfügbar sein sowie die Datei <em>.htaccess.default</em> in <em>.htaccess</em> umbenannt und gegebenenfalls die RewriteBase angepasst werden.');
...
$GLOBALS['TL_LANG']['tl_settings']['useSMTP']             = array('E-Mails via SMTP versenden', 'Einen SMTP-Server statt der PHP-Funktion <em>mail()</em> für den E-Mail-Versand verwenden.');
