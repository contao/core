...
$GLOBALS['TL_LANG']['tl_page']['dns']            = array('Domainnamen', 'Hier können Sie den Zugriff auf die Webseite auf bestimmte Domainnamen beschränken (mehrere Domains mit Leerzeichen getrennt).');
...
$GLOBALS['TL_LANG']['tl_page']['mobileLayout']   = array('Layout für mobile Seiten', 'Dieses Layout wird verwendet, wenn der Besucher ein mobiles Endgerät nutzt.');
