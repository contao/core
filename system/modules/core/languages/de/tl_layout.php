...
$GLOBALS['TL_LANG']['tl_layout']['framework']      = array('CSS-Framework', 'Hier können Sie die Komponenten des Contao CSS-Framework aktivieren.');
$GLOBALS['TL_LANG']['tl_layout']['reset.css']      = array('CSS-Reset', 'Entfernt die inkonsistente Standardformatierung der HTML-Elemente in verschiedenen Browsern.');
$GLOBALS['TL_LANG']['tl_layout']['layout.css']     = array('Layout-Builder', 'Erstellt das CSS-Layout auf Basis der Seitenlayout-Einstellungen. Diese Komponente muss aktiv sein, damit der Seitengenerator korrekt arbeitet!');
$GLOBALS['TL_LANG']['tl_layout']['responsive.css'] = array('Responsive Grid', 'Erzeugt ein responsives 12-Spalten Grid, das mittels der CSS-Klassen "grid1" bis "grid12" sowie "offset1" bis "offset12" gesteuert wird.');
...
$GLOBALS['TL_LANG']['tl_layout']['onload']         = array('Body onload', 'Hier können Sie dem &lt;body&gt;-Tag ein <em>onload</em>-Attribut hinzufügen.');
