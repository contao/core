...
$GLOBALS['TL_LANG']['tl_article']['keywords']    = array('Suchbegriffe', 'Hier können Sie eine kommagetrennte Liste von Suchbegriffen eingeben. Suchbegriffe sind jedoch für die meisten Suchmaschinen (inklusive Google) nicht mehr relevant.');
...
$GLOBALS['TL_LANG']['tl_article']['pasteafter'] = array('Einfügen nach', 'Nach dem Artikel ID %s einfügen');
$GLOBALS['TL_LANG']['tl_article']['pasteinto']  = array('Einfügen in', 'In die Seite ID %s einfügen');
