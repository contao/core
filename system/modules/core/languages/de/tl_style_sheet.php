...
$GLOBALS['TL_LANG']['tl_style_sheet']['embedImages'] = array('Bilder einbetten bis zu', 'Hier können Sie die Dateigröße in Bytes angeben, bis zu der Bilder im Stylesheet als <em>data:</em>-String eingebettet werden. Tragen Sie 0 ein, um die Funktion zu deaktivieren.');
...
$GLOBALS['TL_LANG']['tl_style_sheet']['vars']        = array('Globale Variablen', 'Hier können Sie globale Variablen für das Stylesheet definieren (z.B. <em>$rot</em> &rarr; <em>c00</em> oder <em>$abstand</em> &rarr; <em>12px</em>).');
$GLOBALS['TL_LANG']['tl_style_sheet']['source']      = array('Quelldateien', 'Hier können Sie eine oder mehrere <em>.css</em>-Dateien für den Import hochladen.');
