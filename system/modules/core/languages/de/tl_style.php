...
$GLOBALS['TL_LANG']['tl_style']['bgcolor']        = array('Hintergrund und Deckkraft', 'Hier können Sie eine hexadezimale Hintergrundfarbe (z.B. <em>ff0000</em> für <em>rot</em>) sowie optional die Deckkraft in Prozent (z.B. 75) eingeben.');
...
$GLOBALS['TL_LANG']['tl_style']['shadowcolor']    = array('Schattenfarbe und Deckkraft', 'Hier können Sie eine hexadezimale Schattenfarbe (z.B. <em>ff0000</em> für <em>rot</em>) sowie optional die Deckkraft in Prozent (z.B. 75) eingeben.');
...
$GLOBALS['TL_LANG']['tl_style']['bordercolor']    = array('Rahmenfarbe und Deckkraft', 'Hier können Sie eine hexadezimale Rahmenfarbe (z.B. <em>ff0000</em> für <em>rot</em>) sowie optional die Deckkraft in Prozent (z.B. 75) eingeben.');
...
$GLOBALS['TL_LANG']['tl_style']['fontcolor']      = array('Schriftfarbe und Deckkraft', 'Hier können Sie eine hexadezimale Schriftfarbe (z.B. <em>ff0000</em> für <em>rot</em>) sowie optional die Deckkraft in Prozent (z.B. 75) eingeben.');
...
$GLOBALS['TL_LANG']['tl_style']['letterspacing']  = array('Buchstaben-Abstand', 'Hier können Sie den Buchstaben-Abstand verändern (Standard: <em>0px</em>).');
$GLOBALS['TL_LANG']['tl_style']['wordspacing']    = array('Wort-Abstand', 'Hier können Sie den Wort-Abstand verändern (Standard: <em>0px</em>).');
