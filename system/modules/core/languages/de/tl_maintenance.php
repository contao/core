...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['scripts']  = array('Skriptcache leeren', 'Löscht die automatisch erstellten <em>.css</em>- und <em>.js</em>-Dateien, schreibt die internen Stylesheets neu und leert anschließend den Seitencache.');
...
$GLOBALS['TL_LANG']['tl_maintenance']['notWriteable']  = 'Das temporäre Verzeichnis (<em>system/tmp</em>) ist nicht beschreibbar';
