...
$GLOBALS['TL_LANG']['tl_install']['importException'] = 'Помилка імпорту! Перевірте сумісність структури бази даних та файлу шаблону з використовуваною версією Contao?';
