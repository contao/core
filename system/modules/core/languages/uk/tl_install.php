...
$GLOBALS['TL_LANG']['tl_install']['filesWarning'] = 'Папка, що вказана в налаштунках системи як папка файлів, не існує. Перед початком оновлення системи до версії 3, переконайтеся, що назва папки <em>tl_files</em> не була змінена на <em>files</em>.';
