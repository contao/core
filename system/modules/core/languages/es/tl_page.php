...
$GLOBALS['TL_LANG']['tl_page']['language'][1] = 'Por favor introduce el idioma utilizado en la web actual. Introduce un idioma utilizando la subetiqueta primaria (ISO-639 / RCF3066), por ejemplo "es" para español.';
...
$GLOBALS['TL_LANG']['tl_page']['createSitemap'][1] = 'Crear un mapa de sitio Google XML en el directorio raíz.';
