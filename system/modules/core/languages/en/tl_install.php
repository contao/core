...
$GLOBALS['TL_LANG']['tl_install']['completed']   = array('Congratulations!', 'Now please log into the <a href="contao/">Contao back end</a> and check the system settings. Then visit your website to make sure that Contao is working correctly.');
