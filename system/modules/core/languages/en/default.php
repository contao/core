...
$GLOBALS['TL_LANG']['MSC']['staticPlugins'] = array('Plugins URL', 'The plugins URL applies to all plugins in the <em>assets</em> directory (page speed optimization).');
...
$GLOBALS['TL_LANG']['MSC']['toggleMobile']  = array('Mobile version', 'Go to the mobile version');
$GLOBALS['TL_LANG']['MSC']['toggleDesktop'] = array('Desktop version', 'Go to the desktop version');
