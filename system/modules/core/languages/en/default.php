...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = 'The file or folder "%s" already exists!';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = 'No database entry found for %s.';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = 'The database and the file system have to be synchronized to continue.';
