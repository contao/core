...
$GLOBALS['TL_LANG']['tl_form']['email'][1] = 'Ignores all fields except <em>email</em>, <em>subject</em>, <em>message</em> and <em>cc</em> (carbon copy) and sends the form data like it had been sent from a mail client. File uploads are allowed.';
...
$GLOBALS['TL_LANG']['tl_form']['tableless'][0] = 'Tableless layout';
$GLOBALS['TL_LANG']['tl_form']['tableless'][1] = 'Render the form without HTML tables.';
...
$GLOBALS['TL_LANG']['tl_form']['new'][0] = 'New form';
$GLOBALS['TL_LANG']['tl_form']['new'][1] = 'Create a new form';
$GLOBALS['TL_LANG']['tl_form']['show'][0] = 'Form details';
$GLOBALS['TL_LANG']['tl_form']['show'][1] = 'Show the details of form ID %s';
$GLOBALS['TL_LANG']['tl_form']['edit'][0] = 'Edit form';
$GLOBALS['TL_LANG']['tl_form']['edit'][1] = 'Edit form ID %s';
$GLOBALS['TL_LANG']['tl_form']['editheader'][0] = 'Edit form settings';
$GLOBALS['TL_LANG']['tl_form']['editheader'][1] = 'Edit the settings of form ID %s';
$GLOBALS['TL_LANG']['tl_form']['copy'][0] = 'Duplicate form';
$GLOBALS['TL_LANG']['tl_form']['copy'][1] = 'Duplicate form ID %s';
$GLOBALS['TL_LANG']['tl_form']['delete'][0] = 'Delete form';
$GLOBALS['TL_LANG']['tl_form']['delete'][1] = 'Delete form ID %s';
