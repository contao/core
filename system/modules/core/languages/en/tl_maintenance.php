...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['images']   = array('Purge the image cache', 'Removes the automatically generated images and then purges the page cache, so there are no links to deleted resources.');
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['scripts']  = array('Purge the script cache', 'Removes the automatically generated <em>.css</em> and <em>.js</em> files, recreates the internal style sheets and then purges the page cache.');
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml']      = array('Recreate the XML files', 'Recreates the XML files (sitemaps and feeds) and then purges the page cache, so there are no links to deleted resources.');
...
$GLOBALS['TL_LANG']['tl_maintenance']['notWriteable']  = 'The temporary folder (<em>system/tmp</em>) is not writeable';
