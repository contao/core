...
$GLOBALS['TL_LANG']['tl_style_sheet']['embedImages'] = array('Embed images up to', 'Here you can enter the file size in bytes up to which images will be embedded in the style sheet as <em>data:</em> string. Set to 0 to disable the feature.');
...
$GLOBALS['TL_LANG']['tl_style_sheet']['vars']        = array('Global variables', 'Here you can define global variables for the style sheet (e.g. <em>$red</em> &rarr; <em>c00</em> or <em>$margin</em> &rarr; <em>12px</em>).');
$GLOBALS['TL_LANG']['tl_style_sheet']['source']      = array('Source files', 'Here you can upload one or more <em>.css</em> files to be imported.');
