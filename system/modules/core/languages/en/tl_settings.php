...
$GLOBALS['TL_LANG']['tl_settings']['tokenWhitelist']      = array('Request token whitelist', 'Here you can grant permission to one or more URLs to send POST requests without a valid token. Enter one domain per line and validate incoming requests appropriately.');
...
$GLOBALS['TL_LANG']['tl_settings']['token_legend']    = 'Request tokens';
