...
$GLOBALS['TL_LANG']['tl_settings']['dateFormat']          = array('Date format', 'The date format string will be parsed with the PHP <em>date()</em> function.');
$GLOBALS['TL_LANG']['tl_settings']['timeFormat']          = array('Time format', 'The time format string will be parsed with the PHP <em>date()</em> function.');
$GLOBALS['TL_LANG']['tl_settings']['datimFormat']         = array('Date and time format', 'The date and time format string will be parsed with the PHP <em>date()</em> function.');
...
$GLOBALS['TL_LANG']['tl_settings']['disableCron']         = array('Disable the command scheduler', 'Disable the periodic command scheduler and execute the <em>cron.php</em> script by a real cron job (which you have to set up manually).');
$GLOBALS['TL_LANG']['tl_settings']['minifyMarkup']        = array('Minify the markup', 'Minify the HTML markup before it is sent to the browser (requires the PHP <em>tidy</em> extension).');
$GLOBALS['TL_LANG']['tl_settings']['gzipScripts']         = array('Compress scripts', 'Create a compressed version of the combined CSS and JavaScript files. Requires adjustments of the <em>.htaccess</em> file.');
...
$GLOBALS['TL_LANG']['tl_settings']['fileSyncExclude']     = array('Exclude folders from synchronisation', 'Here you can enter a comma-separated list of folders which will be exempt from the files synchronisation (e.g. <em>attachments,music_academy</em>). Note that excluded resources cannot be used in e.g. image or download elements!');
...
$GLOBALS['TL_LANG']['tl_settings']['rewriteURL']          = array('Rewrite URLs', 'Make Contao generate static URLs without the <em>index.php</em> fragment. This feature requires <em>mod_rewrite</em>, renaming the <em>.htaccess.default</em> file to <em>.htaccess</em> and adjusting the RewriteBase as necessary.');
...
$GLOBALS['TL_LANG']['tl_settings']['indexProtected']      = array('Index protected pages', 'Use this option carefully and always exclude personalised pages from being indexed!');
$GLOBALS['TL_LANG']['tl_settings']['useSMTP']             = array('Send e-mails via SMTP', 'Use an SMTP server instead of the PHP <em>mail()</em> function to send e-mails.');
