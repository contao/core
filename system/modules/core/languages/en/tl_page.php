...
$GLOBALS['TL_LANG']['tl_page']['dns']            = array('Domain names', 'Here you can restrict the access to the website to certain domain names (multiple domains separated by a space).');
