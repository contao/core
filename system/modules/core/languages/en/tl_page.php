...
$GLOBALS['TL_LANG']['tl_page']['dateFormat']     = array('Date format', 'The date format string will be parsed with the PHP <em>date()</em> function.');
$GLOBALS['TL_LANG']['tl_page']['timeFormat']     = array('Time format', 'The time format string will be parsed with the PHP <em>date()</em> function.');
$GLOBALS['TL_LANG']['tl_page']['datimFormat']    = array('Date and time format', 'The date and time format string will be parsed with the PHP <em>date()</em> function.');
...
$GLOBALS['TL_LANG']['tl_page']['mobileLayout']   = array('Mobile page layout', 'This layout will be used if the visitor uses a mobile device.');
