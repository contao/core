...
$GLOBALS['TL_LANG']['tl_install']['locked'][1] = 'В целях безопасности, мастер установки Contao заблокирован после ввода, более чем трех раз подряд, неправильного пароля. Для разблокирования, откройте локальный файл конфигурации и установите вместо <em>installCount</em> значение <em>0</em>.';
...
$GLOBALS['TL_LANG']['tl_install']['database'][1] = 'Введите параметры для соединения с базой данных.';
$GLOBALS['TL_LANG']['tl_install']['collation'][0] = 'Сопоставление';
$GLOBALS['TL_LANG']['tl_install']['collation'][1] = 'Более подробную информацию см. <a href="http://dev.mysql.com/doc/refman/5.1/en/charset-unicode-sets.html" onclick="window.open(this.href); return false;">Руководство MySQL</a>.';
$GLOBALS['TL_LANG']['tl_install']['update'][0] = 'Обновление таблиц базы данных';
$GLOBALS['TL_LANG']['tl_install']['update'][1] = 'Обратите внимание! Обновление таблиц базы данных при помощи мастера установки Contao, тестировалась только с MySQL и MySQLi драйверами. Если вы используете другую базу данных (напр., Oracle), вы можете установить или обновить вашу базу данных вручную. В этом случае, перейдите к каталогу <strong>system/modules</strong> и найдите во всех подкаталогах файлы <strong>config/database.sql</strong>.';
$GLOBALS['TL_LANG']['tl_install']['template'][0] = 'Импорт шаблона';
$GLOBALS['TL_LANG']['tl_install']['template'][1] = 'Вы можете импортировать предварительно настроенный пример веб-сайта в формате <em>.sql</em> файл из каталога <em>templates</em>. <strong>Внимание! Все существующие данные будут удалены!</strong> Если хотите импортировать тему, то вместо этого действия, используйте менеджер тем в панели управления Contao.';
$GLOBALS['TL_LANG']['tl_install']['admin'][0] = 'Создание учетной записи администратора';
$GLOBALS['TL_LANG']['tl_install']['admin'][1] = 'Если вы импортировали шаблон с примером сайта, предоставляемый в комплекте с системой Contao, то логин администратора будет <strong>k.jones</strong>, а пароль <strong>kevinjones</strong>. Смотрите пример веб-сайта (внешний интерфейс) для получения дополнительной информации.';
$GLOBALS['TL_LANG']['tl_install']['completed'][0] = 'Поздравляем!';
$GLOBALS['TL_LANG']['tl_install']['completed'][1] = 'Теперь войдите в <a href="contao/index.php">Панель управления Contao</a> и проверьте настройки системы. После чего откройте ваш сайт (внешний интерфейс) и убедитесь, что Contao работает правильно.';
...
$GLOBALS['TL_LANG']['tl_install']['keyCreate'] = 'Генерация ключей шифрования';
$GLOBALS['TL_LANG']['tl_install']['keySave'] = 'Создание или сохранение ключа';
...
$GLOBALS['TL_LANG']['tl_install']['saveCollation'] = 'Изменить параметр сортировки';
$GLOBALS['TL_LANG']['tl_install']['updateX'] = 'Вероятно, вы обновляете Contao до версии %s. Если это так, то для обеспечения целостности данных <strong>вам необходимо запустить обновление версии %s</strong>!';
...
$GLOBALS['TL_LANG']['tl_install']['importError'] = 'Выберите файл шаблона!';
$GLOBALS['TL_LANG']['tl_install']['importConfirm'] = 'Шаблон импортирован %s';
$GLOBALS['TL_LANG']['tl_install']['importWarn'] = 'Все существующие данные будут удалены!';
$GLOBALS['TL_LANG']['tl_install']['templates'] = 'Шаблоны';
$GLOBALS['TL_LANG']['tl_install']['doNotTruncate'] = 'Не обрезать таблицы в базе данных';
$GLOBALS['TL_LANG']['tl_install']['importSave'] = 'Импорт шаблона';
...
$GLOBALS['TL_LANG']['tl_install']['filesWarning'] = 'Каталог настроенных файлов не существует. Удостоверьтесь, что вы не переименовали <em>tl_files</em> в <em>files</em> до обновления версии 3.';
