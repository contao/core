...
$GLOBALS['TL_LANG']['tl_install']['database'][1] = 'Введите параметры соединения с базой данных.';
...
$GLOBALS['TL_LANG']['tl_install']['saveCollation'] = 'Изменить параметры сортировки';
