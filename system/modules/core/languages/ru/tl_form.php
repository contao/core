...
$GLOBALS['TL_LANG']['tl_form']['sendViaEmail'][0] = 'Посылать данные формы по e-mail';
...
$GLOBALS['TL_LANG']['tl_form']['recipient'][1] = 'Укажите через запятую, e-mail адреса, одного или нескольких получателей. Вы можете использовать форму "Name [name@domain]".';
$GLOBALS['TL_LANG']['tl_form']['subject'][0] = 'Тема';
$GLOBALS['TL_LANG']['tl_form']['subject'][1] = 'Введите тему сообщения. Если вы не заполните тему, это увеличит вероятность того, что письмо будет признано спамом.';
...
$GLOBALS['TL_LANG']['tl_form']['csv'][1] = 'Данные формы прикрепляются к письму как CSV файл (значения через запятую).';
...
$GLOBALS['TL_LANG']['tl_form']['targetTable'][1] = 'Таблица должна содержать столбцы для каждого поля формы.';
$GLOBALS['TL_LANG']['tl_form']['method'][0] = 'Метод передачи формы';
$GLOBALS['TL_LANG']['tl_form']['method'][1] = 'По умолчанию используется метод передачи передачи POST.';
...
$GLOBALS['TL_LANG']['tl_form']['formID'][1] = 'Специальный ID формы (некоторые расширения Contao могут требовать специальный ID).';
$GLOBALS['TL_LANG']['tl_form']['tableless'][0] = 'Бестабличная вёрстка';
$GLOBALS['TL_LANG']['tl_form']['tableless'][1] = 'Отображение формы без использования HTML таблицы.';
$GLOBALS['TL_LANG']['tl_form']['allowTags'][0] = 'Разрешить HTML-теги';
$GLOBALS['TL_LANG']['tl_form']['allowTags'][1] = 'Разрешить HTML-теги в полях формы. По умолчанию, все HTML-теги удаляются в целях безопасности. Однако, вы можете выбрав эту опцию, разрешить определенные HTML-теги.';
