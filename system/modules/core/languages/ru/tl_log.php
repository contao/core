...
$GLOBALS['TL_LANG']['tl_log']['ip'][1] = 'IP-адрес пользователя';
$GLOBALS['TL_LANG']['tl_log']['browser'][0] = 'Браузер';
$GLOBALS['TL_LANG']['tl_log']['browser'][1] = 'Поле User-Agent';
$GLOBALS['TL_LANG']['tl_log']['BE'] = 'Панель управления';
$GLOBALS['TL_LANG']['tl_log']['FE'] = 'Внешний интерфейс';
$GLOBALS['TL_LANG']['tl_log']['show'][0] = 'Показать детали';
$GLOBALS['TL_LANG']['tl_log']['show'][1] = 'Показать детали записи ID %s';
$GLOBALS['TL_LANG']['tl_log']['delete'][0] = 'Удалить';
$GLOBALS['TL_LANG']['tl_log']['delete'][1] = 'Удалить запись ID %s';
