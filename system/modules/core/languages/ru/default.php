...
$GLOBALS['TL_LANG']['ERR']['fileExists'] = 'Файл или папка "%s" уже существует!';
...
$GLOBALS['TL_LANG']['ERR']['fileNotFoundSync'] = 'Не найдена запись базы данных для %s.';
$GLOBALS['TL_LANG']['ERR']['dbOutOfSync'] = 'Для продолжения синхронизируйте базу данных и файловую систему.';
