...
$GLOBALS['TL_LANG']['ERR']['multipleFallback'] = 'Вы можете определить только один корень сайта на домен, в качестве языка обратной связи.';
...
$GLOBALS['TL_LANG']['CTE']['gallery'][1] = 'Создает миниатюры изображений, с возможностью полноразмерного просмотра.';
...
$GLOBALS['TL_LANG']['PTY']['forward'][1] = 'Тип страницы автоматически переправляет посетителей на другую страницу в структуре сайта.';
$GLOBALS['TL_LANG']['PTY']['root'][0] = 'Корень веб-сайта';
$GLOBALS['TL_LANG']['PTY']['root'][1] = 'Тип страницы является отправной точкой нового сайта в структуре сайта.';
...
$GLOBALS['TL_LANG']['MSC']['adminText'] = 'Новый участник (ID %s) зарегистрирован на сайте. %s Если e-mail активация не разрешена, следует активировать учетную запись вручную, через панель управления.';
...
$GLOBALS['TL_LANG']['MSC']['invalidTokenUrl'] = 'Неверный маркер';
