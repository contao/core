...
$GLOBALS['TL_LANG']['ERR']['phone'] = 'Введите подлинный телефонный номер!';
...
$GLOBALS['TL_LANG']['ERR']['alias'] = 'Пожалуйста, введите только буквы, цифры и следующие специальные символы:.-_';
$GLOBALS['TL_LANG']['ERR']['folderalias'] = 'Пожалуйста, введите только буквы, цифры и следующие специальные символы: .-/_';
...
$GLOBALS['TL_LANG']['ERR']['filesize'] = 'Максимальный размер файла для загрузки %s (Contao или настройки php.ini)!';
...
$GLOBALS['TL_LANG']['ERR']['passwordName'] = 'Ваш логин не должен совпадать с паролем!';
...
$GLOBALS['TL_LANG']['ERR']['circularReference'] = 'Неверный обьект переадресации (циклическая ссылка)!';
$GLOBALS['TL_LANG']['ERR']['ie6warning'] = '<strong>Внимание!</strong> Версия вашего браузера %sустарела%s и <strong>вы не можете использовать все возможности веб-сайта</strong>.';
$GLOBALS['TL_LANG']['ERR']['noFallbackEmpty'] = 'Ни в одном из имеющихся активных корней сайта не включена в настройках DNS опция \'Язык обратной связи\'. Это означает, что эти сайты доступны только на одном языке, указанном в настройках страницы! Посетители и поисковые системы, которые \'не говорят\' на этом языке не смогут просматривать этот сайт.';
$GLOBALS['TL_LANG']['ERR']['noFallbackDns'] = 'Ни в одном из имеющихся активных корней сайта <strong>%s</strong> не включена в настройках DNS опция \'Язык обратной связи\'. Это означает, что эти сайты доступны только на одном языке, указанном в настройках страницы! Посетители и поисковые системы, которые \'не говорят\' на этом языке не смогут просматривать этот сайт.';
$GLOBALS['TL_LANG']['ERR']['multipleFallback'] = 'Вы можете определить только один корень сайта на домен, как язык обратной связи.';
$GLOBALS['TL_LANG']['ERR']['topLevelRoot'] = 'Страницей верхнего уровня должен быть корень сайта!';
$GLOBALS['TL_LANG']['ERR']['topLevelRegular'] = 'Имеются страницы верхнего уровня, которые не являются корнем сайта. Создание сайтов без корневой страницы больше не поддерживается, убедитесь, что все страницы сгруппированы под корневой страницей сайта.';
$GLOBALS['TL_LANG']['ERR']['invalidTokenUrl'] = 'Ссылка, которую вы пытались открыть не может быть проверена. Если Вы нажали на ссылку самостоятельно или получили её от доверенного лица, вы можете подтвердить процесс ниже.';
$GLOBALS['TL_LANG']['ERR']['version2format'] = 'Этот элемент по-прежнему использует старый Contao 2 SRC формат. Обновили ли Вы базу данных?';
...
$GLOBALS['TL_LANG']['SEC']['question2'] = 'Что является суммой %d и %d?';
$GLOBALS['TL_LANG']['SEC']['question3'] = 'Сложите %d плюс %s.';
...
$GLOBALS['TL_LANG']['CTE']['text'][1] = 'Создает элемент форматированного текста. Кроме того, вы можете добавить изображение к этому элементу.';
$GLOBALS['TL_LANG']['CTE']['html'][0] = 'HTML-код';
$GLOBALS['TL_LANG']['CTE']['html'][1] = 'Позволяет добавлять пользовательский HTML-код. Примечание: некоторые HTML-теги отключены в целях безопасности.';
$GLOBALS['TL_LANG']['CTE']['list'][0] = 'Список';
$GLOBALS['TL_LANG']['CTE']['list'][1] = 'Создает упорядоченный или неупорядоченный список.';
$GLOBALS['TL_LANG']['CTE']['table'][0] = 'Таблица';
$GLOBALS['TL_LANG']['CTE']['table'][1] = 'Создает при необходимости сортируемые таблицы.';
$GLOBALS['TL_LANG']['CTE']['accordion'][0] = 'Раздвижная панель (Accordion)';
$GLOBALS['TL_LANG']['CTE']['accordion'][1] = 'Создает раздвижную панель контента (Accordion). Примечание: элемент требует использования шаблона mootools JavaScript, который вы можете выбрать в модуле "Макет страницы\'.';
$GLOBALS['TL_LANG']['CTE']['code'][0] = 'Код';
$GLOBALS['TL_LANG']['CTE']['code'][1] = 'Выделяет фрагменты кода и выводит их на экран. Код, только отображается на экране, но не исполняется.';
...
$GLOBALS['TL_LANG']['CTE']['image'][1] = 'Создает отдельное изображение.';
$GLOBALS['TL_LANG']['CTE']['gallery'][0] = 'Галерея изображений';
$GLOBALS['TL_LANG']['CTE']['gallery'][1] = 'Создает миниатюры изображений, которые можно просмотреть в полный размер.';
...
$GLOBALS['TL_LANG']['CTE']['download'][0] = 'Загрузка с сайта';
$GLOBALS['TL_LANG']['CTE']['download'][1] = 'Создает гиперссылку на файл, который может быть загружен посетителями.';
$GLOBALS['TL_LANG']['CTE']['downloads'][0] = 'Загрузки с сайта';
$GLOBALS['TL_LANG']['CTE']['downloads'][1] = 'Создает несколько ссылок на файлы, которые могут загружены посетителями.';
...
$GLOBALS['TL_LANG']['CTE']['alias'][0] = 'Ссылка';
$GLOBALS['TL_LANG']['CTE']['alias'][1] = 'Позволяет показать определенный существующий элемент контента более чем в одной статье.';
...
$GLOBALS['TL_LANG']['CTE']['module'][1] = 'Позволяет внедрять модули (напр. \'Меню навигации\' или Flash-ролик) в статью.';
...
$GLOBALS['TL_LANG']['PTY']['regular'][0] = 'Регулярная страница';
$GLOBALS['TL_LANG']['PTY']['regular'][1] = 'Регулярная страница содержит статьи и элементы. Это тип страницы по умолчанию.';
$GLOBALS['TL_LANG']['PTY']['redirect'][0] = 'Переадресация на внешний URL';
$GLOBALS['TL_LANG']['PTY']['redirect'][1] = 'Тип страницы автоматически перенаправляет посетителя на внешний сайт. Работает как гиперссылка.';
$GLOBALS['TL_LANG']['PTY']['forward'][0] = 'Переадресация на другую страницу';
$GLOBALS['TL_LANG']['PTY']['forward'][1] = 'Тип страницы автоматически переправляет посетителей на другую страницу в структуре сайта. Перенаправление использует ID страницы или ее алиас.';
$GLOBALS['TL_LANG']['PTY']['root'][0] = 'Корень веб-сайта';
$GLOBALS['TL_LANG']['PTY']['root'][1] = 'Тип страницы является отправной точкой нового сайта в структуре сайта. Если вы хотите создать более одного сайта в пределах одного и того же дерева страниц, вы можете определить новую стартовую страницу. Корень веб-сайта служит для привязки DNS, другого языка, или и для того, и другого.';
$GLOBALS['TL_LANG']['PTY']['error_403'][0] = 'Ошибка 403 (доступ запрещен)';
$GLOBALS['TL_LANG']['PTY']['error_403'][1] = 'Страница выводится пользователю, когда он пытается получить доступ к защищенной странице без разрешения. Если эта страница ошибочно помещена в корень, то работа сайта будет ограничена.';
$GLOBALS['TL_LANG']['PTY']['error_404'][0] = 'Ошибка 404 (страница не найдена)';
$GLOBALS['TL_LANG']['PTY']['error_404'][1] = 'Страница выводится, когда пользователь пытается получить доступ к несуществующей странице. Если эта страница ошибочно помещена в корень, то работа сайта будет ограничена.';
$GLOBALS['TL_LANG']['FOP']['fop'][0] = 'Разрешенные операции с файлом';
$GLOBALS['TL_LANG']['FOP']['fop'][1] = 'Выберите разрешенные операции с файлом. Разрешения применимы только к существующим каталогам.';
$GLOBALS['TL_LANG']['FOP']['f1'] = 'Загрузить файлы на сервер';
$GLOBALS['TL_LANG']['FOP']['f2'] = 'Редактировать, копировать или перемещать файлы и каталоги';
...
$GLOBALS['TL_LANG']['MSC']['url'][1] = 'Введите URL назначения, включая сетевой протокол (http://…), для e-mail адреса (mailto:…). Вы также можете использовать теги (напр. <em>link_url</em>).';
$GLOBALS['TL_LANG']['MSC']['target'][0] = 'Открыть в новом окне';
$GLOBALS['TL_LANG']['MSC']['target'][1] = 'Если вы выберете эту опцию, указанный URL откроется в новом окне браузера.';
...
$GLOBALS['TL_LANG']['MSC']['source'][1] = 'Выберите из каталога файлов CSV-файлы, которые хотите импортировать.';
...
$GLOBALS['TL_LANG']['MSC']['tw_ccopy'] = 'Дублировать столбец';
$GLOBALS['TL_LANG']['MSC']['tw_cmovel'] = 'Переместить столбец на одну позицию влево';
$GLOBALS['TL_LANG']['MSC']['tw_cmover'] = 'Переместить столбец на одну позицию вправо';
$GLOBALS['TL_LANG']['MSC']['tw_cdelete'] = 'Удалить столбец';
...
$GLOBALS['TL_LANG']['MSC']['mw_column'] = 'Столбец';
...
$GLOBALS['TL_LANG']['MSC']['center_center'][0] = 'Центр центра (Center center)';
...
$GLOBALS['TL_LANG']['MSC']['right_center'][0] = 'Правый центр (Right center)';
...
$GLOBALS['TL_LANG']['MSC']['right_bottom'][0] = 'Правый низ (Right bottom)';
$GLOBALS['TL_LANG']['MSC']['right_bottom'][1] = 'Сохраняет левую часть альбомного изображения и нижнюю часть портретного изображения.';
$GLOBALS['TL_LANG']['MSC']['id'][0] = 'ID';
$GLOBALS['TL_LANG']['MSC']['id'][1] = 'ID – это уникальный идентификационный номер записи в таблице. ID обычно назначаются автоматически. Внимание, изменение идентификатора может привести к нарушению целостности данных!';
$GLOBALS['TL_LANG']['MSC']['pid'][0] = 'Родительский ID';
$GLOBALS['TL_LANG']['MSC']['pid'][1] = 'Родительский ID – это идентификационный номер для связи вышестоящей записи со следующими после неё. Родительские ID обычно назначаются автоматически. Внимание, изменение родительского идентификатора может привести к нарушению целостности данных!';
...
$GLOBALS['TL_LANG']['MSC']['all'][0] = 'Редактировать все записи';
...
$GLOBALS['TL_LANG']['MSC']['staticFiles'][1] = 'URL файлов применяется к каталогу <em>tl_files</em> и всем эскизам изображений (оптимизация скорости страниц).';
$GLOBALS['TL_LANG']['MSC']['staticPlugins'][0] = 'URL плагинов';
$GLOBALS['TL_LANG']['MSC']['staticPlugins'][1] = 'URL плагинов применяется ко всем ресурсам каталога <em>plugins</em> (оптимизация скорости страниц).';
$GLOBALS['TL_LANG']['MSC']['shortcuts'][0] = 'Комбинации клавиш панели управления';
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Узнайте больше об ускорении рабочего процесса при помощи <a href="http://www.contao.org/keyboard-shortcuts.html" target="_blank">комбинаций клавиш</a>.';
...
$GLOBALS['TL_LANG']['MSC']['lockedAccount'][1] = "Следующая учетная запись Contao была заблокирована по соображениям безопасности.⏎ ⏎ Имя пользователя: %s⏎ Реальное имя: %s⏎ Сайт: %s⏎ ⏎ Учетная запись заблокирована на %d минут, так как пользователь ввел неверный пароль три раза подряд. После истечения этого периода времени, учетная запись будет автоматически разблокирована.⏎ ⏎ Это письмо создано Contao. Вы не можете отвечать на него напрямую.⏎\n";
...
$GLOBALS['TL_LANG']['MSC']['feLink'] = 'Показать внешний интерфейс';
$GLOBALS['TL_LANG']['MSC']['fePreview'] = 'Предпросмотр';
$GLOBALS['TL_LANG']['MSC']['fePreviewTitle'] = 'Предпросмотр сайта в новом окне';
$GLOBALS['TL_LANG']['MSC']['feUser'] = 'Пользователь внешнего интерфейса';
$GLOBALS['TL_LANG']['MSC']['backToTop'] = 'Наверх';
$GLOBALS['TL_LANG']['MSC']['backToTopTitle'] = 'Наверх';
$GLOBALS['TL_LANG']['MSC']['home'] = 'Домой';
$GLOBALS['TL_LANG']['MSC']['homeTitle'] = 'Вернуться к начальной странице внутреннего интерфейса';
$GLOBALS['TL_LANG']['MSC']['user'] = 'Пользователь';
$GLOBALS['TL_LANG']['MSC']['loginTo'] = 'Вход в панель управления сайтом: <em>%s</em>';
...
$GLOBALS['TL_LANG']['MSC']['cancelBT'] = 'Отменить';
...
$GLOBALS['TL_LANG']['MSC']['all_info'] = 'Редактировать все активные записи в таблице %s';
...
$GLOBALS['TL_LANG']['MSC']['colorpicker'] = 'Сборщик цветов (JavaScript должен быть включен)';
$GLOBALS['TL_LANG']['MSC']['pagepicker'] = 'Сборщик страниц (JavaScript должен быть включен)';
$GLOBALS['TL_LANG']['MSC']['filepicker'] = 'Сборщик файлов (JavaScript должен быть включен)';
...
$GLOBALS['TL_LANG']['MSC']['files'] = '%s файл(ы)';
...
$GLOBALS['TL_LANG']['MSC']['deleteSelected'] = 'Удалить выбранное';
$GLOBALS['TL_LANG']['MSC']['editSelected'] = 'Редактировать выбранное';
...
$GLOBALS['TL_LANG']['MSC']['aliasSelected'] = 'Создать псевдонимы';
...
$GLOBALS['TL_LANG']['MSC']['coreOnlyMode'] = 'Contao запущен в <strong>безопасном режиме</strong>, в котором загружаются только основные модули системы. Например, этот режим работы активируется после Он-лайн обновления, для предотвращения возможной несовместимости с модулями сторонних разработчиков. Вы можете отключить его в настройках панели управления после проверки совместимости с установленными модулями сторонних разработчиков.';
...
$GLOBALS['TL_LANG']['MSC']['adminText'] = 'Новый пользователь (ID %s) зарегистрирован на сайте. %s Если вы не запрашивали e-mail активацию, следует активировать учетную запись вручную, через панель управления.';
...
$GLOBALS['TL_LANG']['MSC']['identicalVersions'] = 'Две выбранные версии не различаются.';
$GLOBALS['TL_LANG']['MSC']['selectNewPosition'] = 'Далее, пожалуйста выберите (новое) расположение элемента';
...
$GLOBALS['TL_LANG']['MSC']['facebookShare'] = 'Публиковать на Facebook';
$GLOBALS['TL_LANG']['MSC']['twitterShare'] = 'Публиковать на Twitter';
$GLOBALS['TL_LANG']['MSC']['gplusShare'] = 'Поделиться на Google+';
$GLOBALS['TL_LANG']['MSC']['pleaseWait'] = 'Подождите пожалуйста';
...
$GLOBALS['TL_LANG']['MSC']['invalidPage'] = 'Извините, страница "%s" не существует.';
$GLOBALS['TL_LANG']['MSC']['list_orderBy'] = 'Исходный запрос %s';
...
$GLOBALS['TL_LANG']['MSC']['invalidTokenUrl'] = 'Недопустимый маркер';
...
$GLOBALS['TL_LANG']['CONFIRM']['table'] = 'Затронутая таблица';
$GLOBALS['TL_LANG']['CONFIRM']['act'] = 'Действие';
$GLOBALS['TL_LANG']['CONFIRM']['id'] = 'Затронутая запись';
