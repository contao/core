...
$GLOBALS['TL_LANG']['XPL']['highlighter'][0][1] = 'Для получения дополнительной информации о настройке синтаксиса, посетите <a href="http://alexgorbatchev.com/wiki/SyntaxHighlighter:Configuration#SyntaxHighlighter.defaults" title="SyntaxHighlighter от Alex Gorbatchev" target="_blank">http://alexgorbatchev.com</a>.';
