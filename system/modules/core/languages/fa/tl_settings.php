...
$GLOBALS['TL_LANG']['tl_settings']['websiteTitle'][0] = 'عنوان وب‌سایت';
$GLOBALS['TL_LANG']['tl_settings']['websiteTitle'][1] = 'لطفا عنوان وب‌سایت را وارد نمائید.';
$GLOBALS['TL_LANG']['tl_settings']['adminEmail'][0] = 'آدرس پست‌الکترونیک مدیر وب‌سایت';
$GLOBALS['TL_LANG']['tl_settings']['adminEmail'][1] = 'پیغام‌های خودکار مانند ایمیل تایید عضویت به این آدرس فرستاده خواهند شد.';
...
$GLOBALS['TL_LANG']['tl_settings']['timeFormat'][0] = 'ساختار زمان';
$GLOBALS['TL_LANG']['tl_settings']['timeFormat'][1] = 'رشته ساختار زمان که توسط تابع PHP date() استفاده خواهد شد.';
$GLOBALS['TL_LANG']['tl_settings']['datimFormat'][0] = 'ساختار تاریخ و زمان';
$GLOBALS['TL_LANG']['tl_settings']['datimFormat'][1] = 'رشته ساختار تاریخ و زمان که توسط تابع PHP date() استفاده خواهد شد.';
$GLOBALS['TL_LANG']['tl_settings']['timeZone'][0] = 'منطقه زمانی';
$GLOBALS['TL_LANG']['tl_settings']['timeZone'][1] = 'لطفا منطقه زمانی سرور را انتخاب نمائید.';
$GLOBALS['TL_LANG']['tl_settings']['websitePath'][0] = 'مسیر نسبی پوشه کانتائو';
$GLOBALS['TL_LANG']['tl_settings']['websitePath'][1] = 'مسیر نسبی پوشه کانتائو معمولا به صورت خودکار توسط ابزار نصب تنظیم می‌شود.';
$GLOBALS['TL_LANG']['tl_settings']['characterSet'][0] = 'مجموعه کاراکتر';
...
$GLOBALS['TL_LANG']['tl_settings']['cacheMode'][0] = 'نوع نهانگاه';
...
$GLOBALS['TL_LANG']['tl_settings']['allowedTags'][1] = 'اینجا می‌توانید فهرستی از برچسب‌های اچ‌تی‌ام‌ال مجاز که نباید حذف شوند را وارد نمایید.';
$GLOBALS['TL_LANG']['tl_settings']['debugMode'][0] = 'فعال کردن حالت اشکال‌زادیی';
$GLOBALS['TL_LANG']['tl_settings']['debugMode'][1] = 'چاپ اطلاعات خاص زمان-اجراء مانند پرسش‌های پایگاه داده در صفحه نمایش.';
$GLOBALS['TL_LANG']['tl_settings']['bypassCache'][0] = 'کنار گذاشتن نهانگاه داخلی';
$GLOBALS['TL_LANG']['tl_settings']['bypassCache'][1] = 'استفاده نکردن از پرونده‌های نهانگاه داخلی (مناسب برای توسعه افزونه‌ها).';
...
$GLOBALS['TL_LANG']['tl_settings']['lockPeriod'][1] = 'اگر کاربری بیش از سه بار پشت سر هم رمزعبور اشتباه وارد نمایید قفل خواهد شد.';
$GLOBALS['TL_LANG']['tl_settings']['displayErrors'][0] = 'نمایش پیغام‌های خطاء';
$GLOBALS['TL_LANG']['tl_settings']['displayErrors'][1] = 'چاپ پیغام‌های خطاء در صفحه نمایش (برای وب‌سایت‌های تولیدی توصیه نمی‌شود).';
...
$GLOBALS['TL_LANG']['tl_settings']['disableIpCheck'][1] = 'متصل نکردن نشست‌ها به آدرس‌های آی‌پی. انتخاب این گزینه یک خطر امنیتی بالقوه است!';
$GLOBALS['TL_LANG']['tl_settings']['allowedDownload'][0] = 'نوع‌های پرونده‌های قابل دانلود';
$GLOBALS['TL_LANG']['tl_settings']['allowedDownload'][1] = 'اینجا باید فهرست جدا شده با کامل از انواع پرونده‌های قابل دانلود را وارد نمایید.';
...
$GLOBALS['TL_LANG']['tl_settings']['maxImageWidth'][0] = 'عرض بیشینه در بخش پیشخوان';
$GLOBALS['TL_LANG']['tl_settings']['jpgQuality'][0] = 'کیفیت تصویر بندانگشتی JPG';
...
$GLOBALS['TL_LANG']['tl_settings']['uploadPath'][0] = 'فهرست پرونده‌ها';
$GLOBALS['TL_LANG']['tl_settings']['uploadTypes'][0] = 'انواع پرونده بارگذاری';
$GLOBALS['TL_LANG']['tl_settings']['uploadFields'][0] = 'بازگذاری‌های همزمان پرونده';
$GLOBALS['TL_LANG']['tl_settings']['maxFileSize'][0] = 'بیشینه اندازه فایل بارگذاری';
$GLOBALS['TL_LANG']['tl_settings']['imageWidth'][0] = 'عرض تصویر بیشینه';
$GLOBALS['TL_LANG']['tl_settings']['imageHeight'][0] = 'ارتفاع تصویر بیشینه';
$GLOBALS['TL_LANG']['tl_settings']['enableSearch'][0] = 'فعال کردن جستجو';
...
$GLOBALS['TL_LANG']['tl_settings']['smtpEnc'][1] = 'روش رمز گذاری (SSL یا TLS) را انتخاب نمایید.';
$GLOBALS['TL_LANG']['tl_settings']['smtpPort'][0] = 'شماره درگاه SMTP';
$GLOBALS['TL_LANG']['tl_settings']['smtpPort'][1] = 'شماره درگاه سرور SMTP را وارد نمایید.';
$GLOBALS['TL_LANG']['tl_settings']['inactiveModules'][0] = 'افزونه‌های غیرفعال';
$GLOBALS['TL_LANG']['tl_settings']['inactiveModules'][1] = 'می‌توانید افزونه‌های غیرلازم را غیرفعال نمائید.';
$GLOBALS['TL_LANG']['tl_settings']['undoPeriod'][0] = 'زمان ذخیره‌سازی برای بازگردانی مراحل';
$GLOBALS['TL_LANG']['tl_settings']['undoPeriod'][1] = 'می‌توانید زمان ذخیره‌سازی بازگردانی مراحل را به ثانیه وارد نمایید (۲۴ ساعت = ۸۶۴۰۰ ثانیه).';
$GLOBALS['TL_LANG']['tl_settings']['versionPeriod'][0] = 'زمان ذخیره مانند برای نسخه‌ها';
$GLOBALS['TL_LANG']['tl_settings']['versionPeriod'][1] = 'می‌توانید زمان ذخیره‌سازی نگارش‌های مختلف یک رکورد را به ثانیه وارد نمایید (۹۰ روز = ۷۷۷۶۰۰ ثانیه).';
$GLOBALS['TL_LANG']['tl_settings']['logPeriod'][0] = 'مدت زمان ذخیره برای ورودی های لاگ';
$GLOBALS['TL_LANG']['tl_settings']['logPeriod'][1] = 'می‌توانید زمان ذخیره‌سازی ورودی‌های گزارش را به ثانیه وارد نمایید (۱۴ روز = ۱۲۰۹۶۰۰ ثانیه).';
$GLOBALS['TL_LANG']['tl_settings']['sessionTimeout'][0] = 'مهلت نشست';
$GLOBALS['TL_LANG']['tl_settings']['sessionTimeout'][1] = 'می‌توانید بیشترین زمان یک نشست  را به ثانیه وارد نمایید (۶۰ دقیقه = ۳۶۰۰ ثانیه).';
$GLOBALS['TL_LANG']['tl_settings']['autologin'][0] = 'زمان ورود خودکار';
$GLOBALS['TL_LANG']['tl_settings']['autologin'][1] = 'می‌توانید دوره ورود خودکار وب‌سایت را تنظیم نمایید (۹۰ روز = ۷۷۷۶۰۰۰ ثانیه).';
$GLOBALS['TL_LANG']['tl_settings']['defaultUser'][0] = 'صاحب پیش‌فرض صفحه';
$GLOBALS['TL_LANG']['tl_settings']['defaultUser'][1] = 'می‌توانید کاربری را به عنوان صاحب پیش‌فرض هر صفحه انتخاب نمایید.';
$GLOBALS['TL_LANG']['tl_settings']['defaultGroup'][0] = 'گروه پیش‌فرض صفحه';
...
$GLOBALS['TL_LANG']['tl_settings']['liveUpdateBase'][0] = 'نشانی وب بروزرسانی لایو';
...
$GLOBALS['TL_LANG']['tl_settings']['frontend_legend'] = 'پیکربندی وب‌سایت';
$GLOBALS['TL_LANG']['tl_settings']['sections_legend'] = 'بخش‌های چیدمان';
$GLOBALS['TL_LANG']['tl_settings']['privacy_legend'] = 'تنظیمات پنهان‌سازی';
$GLOBALS['TL_LANG']['tl_settings']['security_legend'] = 'تنظیمات امنیتی';
$GLOBALS['TL_LANG']['tl_settings']['files_legend'] = 'فایل‌ها و تصاویر';
$GLOBALS['TL_LANG']['tl_settings']['uploads_legend'] = 'تنطیمات بارگذاری';
$GLOBALS['TL_LANG']['tl_settings']['search_legend'] = 'تنظیمات موتور جستجو';
$GLOBALS['TL_LANG']['tl_settings']['smtp_legend'] = 'تنظیمات SMTP';
$GLOBALS['TL_LANG']['tl_settings']['ftp_legend'] = 'هک حالت سالم';
$GLOBALS['TL_LANG']['tl_settings']['modules_legend'] = 'افزونه‌های غیرفعال';
$GLOBALS['TL_LANG']['tl_settings']['timeout_legend'] = 'مقادیر انقضاء';
$GLOBALS['TL_LANG']['tl_settings']['chmod_legend'] = 'سطوح دسترسی پیش‌فرض';
$GLOBALS['TL_LANG']['tl_settings']['update_legend'] = 'بروزرسانی لایو';
$GLOBALS['TL_LANG']['tl_settings']['static_legend'] = 'منابع استاتیک';
$GLOBALS['TL_LANG']['tl_settings']['edit'] = 'ویرایش پیکربندی محلی';
$GLOBALS['TL_LANG']['tl_settings']['both'] = 'استفاده از نهانگاه سرور و مرورگر';
$GLOBALS['TL_LANG']['tl_settings']['server'] = 'استفاده فقط از نهانگاه سرور';
$GLOBALS['TL_LANG']['tl_settings']['browser'] = 'استفاده فقط از نهانگاه مرورگر';
$GLOBALS['TL_LANG']['tl_settings']['none'] = 'غیرفعال کردن نهانگاه';
