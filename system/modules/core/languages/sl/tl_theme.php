...
$GLOBALS['TL_LANG']['tl_theme']['tstamp'][1] = 'Datum in čas zadnje revizije';
...
$GLOBALS['TL_LANG']['tl_theme']['custom_sections'] = 'Prilagojena postavitev razdelkov.';
$GLOBALS['TL_LANG']['tl_theme']['missing_section'] = 'Razdelek postavitve <strong>%s</strong> ni definiran v skrbniških nastavitvah.';
$GLOBALS['TL_LANG']['tl_theme']['sections_ok'] = 'Tema ne vsebuje prilagojenih razdelkov postavitve.';
...
$GLOBALS['TL_LANG']['tl_theme']['new'][0] = 'Nova tema';
$GLOBALS['TL_LANG']['tl_theme']['new'][1] = 'Ustvari novo temo';
$GLOBALS['TL_LANG']['tl_theme']['show'][0] = 'Podrobnosti teme';
$GLOBALS['TL_LANG']['tl_theme']['show'][1] = 'Prikaži podrobnosti teme ID %s';
$GLOBALS['TL_LANG']['tl_theme']['edit'][0] = 'Uredi temo';
$GLOBALS['TL_LANG']['tl_theme']['edit'][1] = 'Uredi temo z ID %s';
$GLOBALS['TL_LANG']['tl_theme']['delete'][0] = 'Izbriši temo';
$GLOBALS['TL_LANG']['tl_theme']['delete'][1] = 'Izbriši temo z ID %s';
$GLOBALS['TL_LANG']['tl_theme']['css'][0] = 'Slogovne predloge';
$GLOBALS['TL_LANG']['tl_theme']['css'][1] = 'Uredi slogovne predloge teme ID %s';
$GLOBALS['TL_LANG']['tl_theme']['modules'][0] = 'Moduli';
$GLOBALS['TL_LANG']['tl_theme']['modules'][1] = 'Uredi predstavitvene module (front end) teme z ID %s';
$GLOBALS['TL_LANG']['tl_theme']['layout'][0] = 'Postavitve';
$GLOBALS['TL_LANG']['tl_theme']['layout'][1] = 'Uredi postavitve strani teme z ID %s';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][0] = 'Uvoz teme';
$GLOBALS['TL_LANG']['tl_theme']['importTheme'][1] = 'Uvozi nove teme';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][0] = 'Izvoz';
$GLOBALS['TL_LANG']['tl_theme']['exportTheme'][1] = 'Izvoz teme ID %s';
