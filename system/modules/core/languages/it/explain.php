...
$GLOBALS['TL_LANG']['XPL']['insertTags'][1][1] = 'Per maggiori informazioni su gli insert tags puoi consultare  la pagina <a href="https://contao.org/en/manual/3.0/managing-content.html#insert-tags" title="Contao online documentation" target="_blank">https://contao.org/en/manual/3.0/managing-content.html#insert-tags</a>.';
...
$GLOBALS['TL_LANG']['XPL']['dateFormat'][2][1] = 'DD/MM/YYYY, formato italiano. Es:. 28/01/2005';
...
$GLOBALS['TL_LANG']['XPL']['highlighter'][0][1] = 'Per maggiori informazioni su come configurare il syntax highlighter visita <a href="http://alexgorbatchev.com/wiki/SyntaxHighlighter:Configuration#SyntaxHighlighter.defaults" title="SyntaxHighlighter by Alex Gorbatchev" target="_blank">http://alexgorbatchev.com</a>.';
