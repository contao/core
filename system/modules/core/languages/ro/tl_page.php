...
$GLOBALS['TL_LANG']['tl_page']['language'][1] = 'Selectaţi limba folosită pe situl curent. Introduceţi o limbă folosind subtag-ul primar (ISO-639 / RCF3066), ex. "en" pentru Engleză sau "ro" pentru Română.';
...
$GLOBALS['TL_LANG']['tl_page']['createSitemap'][1] = 'Creează un Google XML sitemap în directorul rădăcină.';
