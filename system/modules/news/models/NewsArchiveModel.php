 ...
 *
 * @method static \Model\Collection|\NewsArchiveModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByTitle($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByJumpTo($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByProtected($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByGroups($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByAllowComments($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByNotify($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findBySortOrder($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByPerPage($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByModerate($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByBbcode($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByRequireLogin($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findByDisableCaptcha($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\NewsArchiveModel|null findAll($opt=array())
 *
