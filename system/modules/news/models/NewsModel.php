 ...
 *
 * @method static \NewsModel findById($id, $opt=array())
 * @method static \NewsModel findByPk($id, $opt=array())
 * @method static \NewsModel findByIdOrAlias($val, $opt=array())
 * @method static \NewsModel findOneBy($col, $val, $opt=array())
 * @method static \NewsModel findOneByPid($val, $opt=array())
 * @method static \NewsModel findOneByTstamp($val, $opt=array())
 * @method static \NewsModel findOneByHeadline($val, $opt=array())
 * @method static \NewsModel findOneByAlias($val, $opt=array())
 * @method static \NewsModel findOneByAuthor($val, $opt=array())
 * @method static \NewsModel findOneByDate($val, $opt=array())
 * @method static \NewsModel findOneByTime($val, $opt=array())
 * @method static \NewsModel findOneBySubheadline($val, $opt=array())
 * @method static \NewsModel findOneByTeaser($val, $opt=array())
 * @method static \NewsModel findOneByAddImage($val, $opt=array())
 * @method static \NewsModel findOneBySingleSRC($val, $opt=array())
 * @method static \NewsModel findOneByAlt($val, $opt=array())
 * @method static \NewsModel findOneBySize($val, $opt=array())
 * @method static \NewsModel findOneByImagemargin($val, $opt=array())
 * @method static \NewsModel findOneByImageUrl($val, $opt=array())
 * @method static \NewsModel findOneByFullsize($val, $opt=array())
 * @method static \NewsModel findOneByCaption($val, $opt=array())
 * @method static \NewsModel findOneByFloating($val, $opt=array())
 * @method static \NewsModel findOneByAddEnclosure($val, $opt=array())
 * @method static \NewsModel findOneByEnclosure($val, $opt=array())
 * @method static \NewsModel findOneBySource($val, $opt=array())
 * @method static \NewsModel findOneByJumpTo($val, $opt=array())
 * @method static \NewsModel findOneByArticleId($val, $opt=array())
 * @method static \NewsModel findOneByUrl($val, $opt=array())
 * @method static \NewsModel findOneByTarget($val, $opt=array())
 * @method static \NewsModel findOneByCssClass($val, $opt=array())
 * @method static \NewsModel findOneByNoComments($val, $opt=array())
 * @method static \NewsModel findOneByFeatured($val, $opt=array())
 * @method static \NewsModel findOneByPublished($val, $opt=array())
 * @method static \NewsModel findOneByStart($val, $opt=array())
 * @method static \NewsModel findOneByStop($val, $opt=array())
 *
