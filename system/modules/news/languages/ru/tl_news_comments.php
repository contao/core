...
$GLOBALS['TL_LANG']['tl_news_comments']['edit'][1] = 'Редактировать комментарий ID %s';
$GLOBALS['TL_LANG']['tl_news_comments']['delete'][0] = 'Удалить комментарий';
$GLOBALS['TL_LANG']['tl_news_comments']['delete'][1] = 'Удалить комментарий ID %s';
$GLOBALS['TL_LANG']['tl_news_comments']['toggle'][0] = 'Опубликовать/изъять комментарий';
$GLOBALS['TL_LANG']['tl_news_comments']['toggle'][1] = 'Опубликовать/изъять комментарий ID %s';
$GLOBALS['TL_LANG']['tl_news_comments']['editheader'][0] = 'Редактировать архив';
$GLOBALS['TL_LANG']['tl_news_comments']['editheader'][1] = 'Редактировать текущий архив';
