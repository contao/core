...
$GLOBALS['TL_LANG']['tl_news']['default']      = array('Standard', 'Bei Anklicken des "Weiterlesen …"-Links wird der Besucher auf die Standardseite des Nachrichtenarchivs weitergeleitet.');
$GLOBALS['TL_LANG']['tl_news']['internal']     = array('Seite', 'Bei Anklicken des "Weiterlesen …"-Links wird der Besucher auf eine Seite weitergeleitet.');
$GLOBALS['TL_LANG']['tl_news']['article']      = array('Artikel', 'Bei Anklicken des "Weiterlesen …"-Links wird der Besucher auf einen Artikel weitergeleitet.');
$GLOBALS['TL_LANG']['tl_news']['external']     = array('Externe URL', 'Bei Anklicken des "Weiterlesen …"-Links wird der Besucher auf eine externe Webseite weitergeleitet.');
