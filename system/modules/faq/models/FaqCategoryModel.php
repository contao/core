 ...
 *
 * @method static \Model\Collection|\FaqCategoryModel|null findByTstamp($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByTitle($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByHeadline($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByJumpTo($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByAllowComments($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByNotify($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findBySortOrder($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByPerPage($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByModerate($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByBbcode($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByRequireLogin($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findByDisableCaptcha($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findMultipleByIds($val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findBy($col, $val, $opt=array())
 * @method static \Model\Collection|\FaqCategoryModel|null findAll($opt=array())
 *
