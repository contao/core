 ...
 *
 * @method static \FaqModel findById($id, $opt=array())
 * @method static \FaqModel findByPk($id, $opt=array())
 * @method static \FaqModel findByIdOrAlias($val, $opt=array())
 * @method static \FaqModel findOneBy($col, $val, $opt=array())
 * @method static \FaqModel findOneByPid($val, $opt=array())
 * @method static \FaqModel findOneBySorting($val, $opt=array())
 * @method static \FaqModel findOneByTstamp($val, $opt=array())
 * @method static \FaqModel findOneByQuestion($val, $opt=array())
 * @method static \FaqModel findOneByAlias($val, $opt=array())
 * @method static \FaqModel findOneByAuthor($val, $opt=array())
 * @method static \FaqModel findOneByAnswer($val, $opt=array())
 * @method static \FaqModel findOneByAddImage($val, $opt=array())
 * @method static \FaqModel findOneBySingleSRC($val, $opt=array())
 * @method static \FaqModel findOneByAlt($val, $opt=array())
 * @method static \FaqModel findOneBySize($val, $opt=array())
 * @method static \FaqModel findOneByImagemargin($val, $opt=array())
 * @method static \FaqModel findOneByImageUrl($val, $opt=array())
 * @method static \FaqModel findOneByFullsize($val, $opt=array())
 * @method static \FaqModel findOneByCaption($val, $opt=array())
 * @method static \FaqModel findOneByFloating($val, $opt=array())
 * @method static \FaqModel findOneByAddEnclosure($val, $opt=array())
 * @method static \FaqModel findOneByEnclosure($val, $opt=array())
 * @method static \FaqModel findOneByNoComments($val, $opt=array())
 * @method static \FaqModel findOneByPublished($val, $opt=array())
 *
