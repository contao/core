...
$GLOBALS['TL_LANG']['tl_faq']['author'][0] = 'Autors';
...
$GLOBALS['TL_LANG']['tl_faq']['new'][0] = 'Jauns jautājums';
$GLOBALS['TL_LANG']['tl_faq']['new'][1] = 'Izveidot jaunu jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['show'][0] = 'Rādīt jautājuma detaļas';
$GLOBALS['TL_LANG']['tl_faq']['show'][1] = 'Rādīt jautājuma ID %s detaļas';
$GLOBALS['TL_LANG']['tl_faq']['edit'][0] = 'Rediģēt jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['edit'][1] = 'Rediģēt jautājumu ID %s';
$GLOBALS['TL_LANG']['tl_faq']['copy'][0] = 'Dublicēt jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['copy'][1] = 'Dublicēt jautājumu ID %s';
$GLOBALS['TL_LANG']['tl_faq']['cut'][0] = 'Pārvietot jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['cut'][1] = 'Pārvietot jautājumu ID %s';
$GLOBALS['TL_LANG']['tl_faq']['delete'][0] = 'Dzēst jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['delete'][1] = 'Dzēst jautājumu ID %s';
$GLOBALS['TL_LANG']['tl_faq']['toggle'][0] = 'Publicēt/nepublicēt jautājumu';
$GLOBALS['TL_LANG']['tl_faq']['toggle'][1] = 'Publicēt/nepublicēt jautājumu ID %s';
$GLOBALS['TL_LANG']['tl_faq']['editheader'][0] = 'Rediģēt kategoriju';
$GLOBALS['TL_LANG']['tl_faq']['editheader'][1] = 'Rediģēt kategorijas iestatījumus';
$GLOBALS['TL_LANG']['tl_faq']['pasteafter'][0] = 'Ielīmēt augšā';
$GLOBALS['TL_LANG']['tl_faq']['pasteafter'][1] = 'Ielīmēt aiz jautājuma ID %s';
$GLOBALS['TL_LANG']['tl_faq']['pastenew'][0] = 'Pievienot jaunu augšā';
$GLOBALS['TL_LANG']['tl_faq']['pastenew'][1] = 'Pievienot jaunu pēc jautājuma ID %s';
