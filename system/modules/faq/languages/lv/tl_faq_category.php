...
$GLOBALS['TL_LANG']['tl_faq_category']['title'][0] = 'Nosaukums';
...
$GLOBALS['TL_LANG']['tl_faq_category']['sortOrder'][0] = 'Kārtošanas secība';
...
$GLOBALS['TL_LANG']['tl_faq_category']['requireLogin'][1] = 'Atļaut tikai reģistrētiem lietotājiem izveidot komentārus.';
$GLOBALS['TL_LANG']['tl_faq_category']['disableCaptcha'][0] = 'Atspējot drošības jautājumu';
...
$GLOBALS['TL_LANG']['tl_faq_category']['tstamp'][0] = 'Pārskatīšanas datums';
$GLOBALS['TL_LANG']['tl_faq_category']['tstamp'][1] = 'Pēdējās pārskatīšanas datums un laiks';
...
$GLOBALS['TL_LANG']['tl_faq_category']['deleteConfirm'] = 'Izdzēšot kategoriju ID %s tiks izdzēsti arī visi tās BUJi! Turpināt?';
$GLOBALS['TL_LANG']['tl_faq_category']['new'][0] = 'Jauna kategorija';
$GLOBALS['TL_LANG']['tl_faq_category']['new'][1] = 'Izveidot jaunu kategoriju';
$GLOBALS['TL_LANG']['tl_faq_category']['show'][0] = 'Kategorijas detaļas';
$GLOBALS['TL_LANG']['tl_faq_category']['show'][1] = 'Rādīt kategorijas ID %s detaļas';
$GLOBALS['TL_LANG']['tl_faq_category']['edit'][0] = 'Rediģēt kategoriju';
$GLOBALS['TL_LANG']['tl_faq_category']['edit'][1] = 'Rediģēt kategoriju ID %s';
$GLOBALS['TL_LANG']['tl_faq_category']['editheader'][0] = 'Rediģēt kategorijas iestatījumus';
$GLOBALS['TL_LANG']['tl_faq_category']['editheader'][1] = 'Rediģēt kategorijas ID %s iestatījumus';
$GLOBALS['TL_LANG']['tl_faq_category']['copy'][0] = 'Dublicēt kategoriju';
$GLOBALS['TL_LANG']['tl_faq_category']['copy'][1] = 'Dublicēt kategoriju ID %s';
$GLOBALS['TL_LANG']['tl_faq_category']['delete'][0] = 'Dzēst kategoriju';
$GLOBALS['TL_LANG']['tl_faq_category']['delete'][1] = 'Dzēst kategoriju ID %s';
