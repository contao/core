...
$GLOBALS['TL_LANG']['tl_faq']['noComments'][0] = 'Onemogoči komentarje';
$GLOBALS['TL_LANG']['tl_faq']['noComments'][1] = 'Ne dovoli komentarje za ta FAQ.';
...
$GLOBALS['TL_LANG']['tl_faq']['expert_legend'] = 'Napredne nastavitve';
$GLOBALS['TL_LANG']['tl_faq']['publish_legend'] = 'Nastavitve objave';
$GLOBALS['TL_LANG']['tl_faq']['new'][0] = 'Novo vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['new'][1] = 'Ustvari novo vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['show'][0] = 'Prikaži vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['show'][1] = 'Prikaži podrobnosti vprašanja ID %s';
$GLOBALS['TL_LANG']['tl_faq']['edit'][0] = 'Uredi vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['edit'][1] = 'Uredi vprašanje ID %s';
$GLOBALS['TL_LANG']['tl_faq']['copy'][0] = 'Kopiraj vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['copy'][1] = 'Kopiraj vprašanje ID %s';
$GLOBALS['TL_LANG']['tl_faq']['cut'][0] = 'Premakni vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['cut'][1] = 'Premakni vprašanje ID %s';
$GLOBALS['TL_LANG']['tl_faq']['delete'][0] = 'Izbriši vprašanje';
$GLOBALS['TL_LANG']['tl_faq']['delete'][1] = 'Izbriši vprašanje ID %s';
$GLOBALS['TL_LANG']['tl_faq']['toggle'][0] = 'Objavi/neobjavi vprašanja';
$GLOBALS['TL_LANG']['tl_faq']['toggle'][1] = 'Objavi/neobjavi vprašanja ID %s';
$GLOBALS['TL_LANG']['tl_faq']['editheader'][0] = 'Uredi kategorijo';
$GLOBALS['TL_LANG']['tl_faq']['editheader'][1] = 'Uredi trenutno kategorijo';
$GLOBALS['TL_LANG']['tl_faq']['pasteafter'][0] = 'Prilepi na začetek';
$GLOBALS['TL_LANG']['tl_faq']['pasteafter'][1] = 'Prilepi za vprašanje ID %s';
$GLOBALS['TL_LANG']['tl_faq']['pastenew'][0] = 'Ustvari novo vprašanje na začetku';
$GLOBALS['TL_LANG']['tl_faq']['pastenew'][1] = 'Ustvari novo vprašanje za vprašanjem ID %s';
