...
<label for="query_type_<?php echo $this->uniqueId; ?>" class="invisible"><?php echo $this->optionsLabel; ?></label>
<div id="query_type_<?php echo $this->uniqueId; ?>" class="radio_container">
