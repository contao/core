...
$GLOBALS['TL_LANG']['tl_style']['background']     = array('Hintergrund', 'Background-color, background-image, background-position, background-repeat, linear-gradient and box-shadow.');
$GLOBALS['TL_LANG']['tl_style']['bgcolor']        = array('Hintergrundfarbe', 'Hier können Sie eine hexadezimale Hintergrundfarbe eingeben (z.B. ff0000 für rot).');
...
$GLOBALS['TL_LANG']['tl_style']['gradienttop']    = array('Obere Verlaufsfarbe', 'Wenn Sie einen Verlauf erstellen möchten, können Sie hier die obere Farbe eingeben.');
$GLOBALS['TL_LANG']['tl_style']['gradientbottom'] = array('Untere Verlaufsfarbe', 'Wenn Sie einen Verlauf erstellen möchten, können Sie hier die untere Farbe eingeben.');
...
$GLOBALS['TL_LANG']['tl_style']['shadowcolor']    = array('Schattenfarbe', 'Hier können Sie eine hexadezimale Schattenfarbe eingeben (z.B. ff0000 für rot).');
$GLOBALS['TL_LANG']['tl_style']['border']         = array('Rahmen', 'Border-width, border-style, border-color, border-radius, border-collapse and border-spacing.');
...
$GLOBALS['TL_LANG']['tl_style']['bordercolor']    = array('Rahmenfarbe', 'Hier können Sie eine hexadezimale Rahmenfarbe eingeben (z.B. ff0000 für rot).');
...
$GLOBALS['TL_LANG']['tl_style']['fontcolor']      = array('Schriftfarbe', 'Hier können Sie eine hexadezimale Schriftfarbe eingeben (z.B. ff0000 für rot).');
