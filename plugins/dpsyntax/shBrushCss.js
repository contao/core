dp.sh.Brushes.CSS = function()
{
	...
	this.regexList = [
		...
		{ regex: new RegExp('\\#[a-zA-Z][a-zA-Z0-9\\-_\\#]+', 'g'),		css: 'ids' },		// ids
		{ regex: new RegExp('\\.[a-zA-Z][a-zA-Z0-9\\-_\\#]+', 'g'),		css: 'classes' },	// classes
		{ regex: new RegExp('\\#[a-fA-F0-9]{3,6}', 'g'),				css: 'vars' },		// html colors
		{ regex: new RegExp('(\\d+)(px|pt|\:|%)?', 'g'),				css: 'vars' },		// size specifications
		{ regex: new RegExp('!important', 'g'),							css: 'important' },	// important keyword
		{ regex: new RegExp(this.GetKeywords(keywords), 'gm'),			css: 'keyword' },	// keywords
		{ regex: new RegExp(this.GetKeywords(values), 'g'),				css: 'vars' },		// values
		{ regex: new RegExp(this.GetKeywords(fonts), 'g'),				css: 'vars' }		// fonts
		];
