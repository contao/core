...
//			NonverBlaster
				...
				playerpath: 'plugins/mootools/mediabox/1.2.5/NonverBlaster.swf',	// Path to NonverBlaster.swf
				// PATCH EOF
...
//			JW Media Player settings and options
				// PATCH: set path to plugins directory
				JWplayerpath: 'plugins/mootools/mediabox/1.2.5/player.swf',	// Path to the mediaplayer.swf or flvplayer.swf file
				// PATCH EOF
